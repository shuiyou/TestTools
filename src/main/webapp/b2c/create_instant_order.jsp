...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >创建即时到帐交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateInstantOrder" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_instant_order">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">can_repeat: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="can_repeat" class="form-control" id="can_repeat" placeholder="同一订单禁止重复提交标志" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">expired_time: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="expired_time" class="form-control" id="expired_time" placeholder="订单过期时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
