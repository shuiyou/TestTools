...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >交易结算</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../SettleB2COrder" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="settle_b2c_order">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_request_no" class="form-control" id="out_request_no" placeholder="商户请求号" value="">
    						</div>					
						</td>
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成商户请求号" onclick="setRequestNo()"/>
    						</div>	
						</td>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
								<input type="text" name="risk_info" class="form-control" id="risk_info" placeholder="风控规则" value='{"logistics_order_no":"11111111","delivery_time":"20180709120936"}'>
							</div>
						</td>
						<td></td>
					</tr>
