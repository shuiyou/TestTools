...
function setEndTime(){
	var requestTime = document.getElementById('end_time');
	requestTime.value = new Date().Format('yyyyMMddHHmmss');
}
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >分账查询</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../QueryReceiptSplit" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_receipt_split">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">out_split_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_split_no" class="form-control" id="out_split_no" placeholder="分账（退分账）订单号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="start_time" class="form-control" id="start_time" placeholder="开始时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="end_time" class="form-control" id="end_time" placeholder="结束时间" value="">
    						</div>					
						</td>
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成结束时间" onclick="setEndTime()"/>
    						</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="page_no" class="form-control" id="page_no" placeholder="页号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="page_size" class="form-control" id="page_size" placeholder="每页大小" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
