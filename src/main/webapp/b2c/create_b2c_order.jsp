...
function setOutTradeNo(){
	var requestTime = document.getElementById('out_trade_no');
	requestTime.value = new Date().Format('yyyyMMddHHmmss');
}
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >交易创建</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateB2COrder" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_b2c_order">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_trade_no" class="form-control" id="out_trade_no" placeholder="商户订单号" value="">
    						</div>					
						</td>
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成商户订单号" onclick="setOutTradeNo()"/>
    						</div>	
						</td>
					</tr>
					
					<tr>
						<td><label class="col-sm-2 control-label">buyer_identity_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="buyer_identity_id" class="form-control" id="buyer_identity_id" placeholder="买家标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">buyer_identity_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="buyer_identity_type" class="form-control" id="buyer_identity_type" placeholder="买家标识类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">seller_identity_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="seller_identity_id" class="form-control" id="seller_identity_id" placeholder="卖家标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">seller_identity_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="seller_identity_type" class="form-control" id="seller_identity_type" placeholder="卖家标识类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">seller_account_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="seller_account_type" class="form-control" id="seller_account_type" placeholder="卖家账户类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">reported_identity_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="reported_identity_id" class="form-control" id="reported_identity_id" placeholder="报备人标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">reported_identity_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="reported_identity_type" class="form-control" id="reported_identity_type" placeholder="报备人标识类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="amount" class="form-control" id="amount" placeholder="金额" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">product_desc: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="product_desc" class="form-control" id="product_desc" placeholder="商品描述" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">settlement_time: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="settlement_time" class="form-control" id="settlement_time" placeholder="结算时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">can_repay_on_failed: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="can_repay_on_failed" class="form-control" id="can_repay_on_failed" placeholder="支付失败后是否可以再次支付" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">trade_close_time: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="trade_close_time" class="form-control" id="trade_close_time" placeholder="订单过期时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">split_list: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="split_list" class="form-control" id="split_list" placeholder="分账信息列表" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">risk_info: </label></td>
						<td>
							<div class="col-sm-10">
								<input type="text" name="risk_info" class="form-control" id="risk_info" placeholder="风控规则" value='{"goods_code":"11101","goods_id":"sd12312","goods_name":"哈哈","goods_num":"2","goods_price":"2.00","mercht_user_id":"12312","login_name":"136998787878","goods_url":"www.baidu.com","mobile":"peJmfufGl17H2RPV/yB+KLBZTcN3mMr4cAumXgIRAbyNqaESacSy7OEPiNpz2VL+zjflOjt56nShq663pq3QRD5U7UJhUZhPq5ss0eoO6YI7medcPZcPvC9/Njc0Uw0d2mKt+13noPJ2o1B3w9CIzuaC4V5wzFzSrFgfwk7WsUU="}'>
							</div>
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">device_info: </label></td>
						<td>
							<div class="col-sm-10">
								<input type="text" name="device_info" class="form-control" id="device_info" placeholder="风控规则" value='{"device_no":"76:31:c1:c3:10:dc","device_type":"PC","access_type":"WEB"}'>
							</div>
						</td>
						<td></td>
					</tr>
					...
					<%--<tr>--%>
						...
						<%--<td>--%>
			 						<%--<div class="col-sm-10">--%>
			 							<%--<input type="text" name="goods_id" class="form-control" id="goods_id" placeholder="商品编号" value="">--%>
			 						<%--</div>					--%>
						<%--</td>--%>
						<%--<td></td>--%>
					<%--</tr>--%>
					<%--<tr>--%>
						<%--<td><label class="col-sm-2 control-label">goods_name: </label></td>--%>
						<%--<td>--%>
			 						<%--<div class="col-sm-10">--%>
			 							<%--<input type="text" name="goods_name" class="form-control" id="goods_name" placeholder="商品名称" value="">--%>
			 						<%--</div>					--%>
						<%--</td>--%>
						<%--<td></td>--%>
					<%--</tr>--%>
					<%--<tr>--%>
						<%--<td><label class="col-sm-2 control-label">goods_num: </label></td>--%>
						<%--<td>--%>
			 						<%--<div class="col-sm-10">--%>
			 							<%--<input type="text" name="goods_num" class="form-control" id="goods_num" placeholder="商品数量" value="">--%>
			 						<%--</div>					--%>
						<%--</td>--%>
						<%--<td></td>--%>
					<%--</tr>--%>
					<%--<tr>--%>
						<%--<td><label class="col-sm-2 control-label">goods_price: </label></td>--%>
						<%--<td>--%>
			 						<%--<div class="col-sm-10">--%>
			 							<%--<input type="text" name="goods_price" class="form-control" id="goods_price" placeholder="商品单价" value="">--%>
			 						<%--</div>					--%>
						<%--</td>--%>
						<%--<td></td>--%>
					<%--</tr>--%>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_ip" class="form-control" id="payer_ip" placeholder="付款用户ip地址" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">device_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="device_id" class="form-control" id="device_id" placeholder="设备mac地址" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">split_code: </label></td>
						<td>
							<div class="col-sm-10">
								<input type="text" name="split_code" class="form-control" id="split_code" placeholder="只能分账代码" value="">
							</div>
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">split_role_list: </label></td>
						<td>
							<div class="col-sm-10">
								<input type="text" name="split_role_list" class="form-control" id="split_role_list" placeholder="智能分账角色列表" value="">
							</div>
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">cashdesk_addr_category: </label></td>
						<td>
			 						<div class="col-sm-10">
			 							<input type="text" name="cashdesk_addr_category" class="form-control" id="cashdesk_addr_category" placeholder="MOBILE H5方式打开" value="">
			 						</div>					
						</td>
						<td></td>
					</tr>
