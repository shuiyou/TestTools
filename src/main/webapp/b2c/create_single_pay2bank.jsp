...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >单笔付款到银行卡</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateSinglePay2Bank" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_single_pay2bank">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
    							<input type="button" value="设置商户订单号" onclick="setOutTradeNo()"/>
    						</div>	
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="real_name" class="form-control" id="real_name" placeholder="收款银行账户名称" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">cert_num: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="cert_num" class="form-control" id="cert_num" placeholder="收款人身份证号码" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">bank_account_num: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="bank_account_num" class="form-control" id="bank_account_num" placeholder="收款人银行账号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="bank_name" class="form-control" id="bank_name" placeholder="收款人开户银行" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="bank_code" class="form-control" id="bank_code" placeholder="开户银行代码" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="province" class="form-control" id="province" placeholder="收款银行所在省份" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="city" class="form-control" id="city" placeholder="收款银行所在城市" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="bank_branch" class="form-control" id="bank_branch" placeholder="收款支行名称" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="amount" class="form-control" id="amount" placeholder="订单金额" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="card_attribute" class="form-control" id="card_attribute" placeholder="银行卡属性" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="card_type" class="form-control" id="card_type" placeholder="银行卡类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">payto_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payto_type" class="form-control" id="payto_type" placeholder="到账时效" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
