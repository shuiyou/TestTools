...
function setBatchNo(){
	var requestTime = document.getElementById('batch_no');
	requestTime.value = new Date().Format('yyyyMMddHHmmss');
}
...
function setAccountType(){
    var select = document.getElementById('selectAccountType');
    var encryptKey = document.getElementById('account_type');
    switch(select.value){
        case 'BASIC':
            encryptKey.value='BASIC';
            break;
        case 'RESERVE':
            encryptKey.value='RESERVE';
            break;
        default:
            encryptKey.value='';
            break;
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >批量付款到银行卡</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateBatchPay2Bank" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_batch_pay2bank">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">batch_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="batch_no" class="form-control" id="batch_no" placeholder="批次号" value="">
    						</div>					
						</td>
						<td>
							<div class="col-sm-10">
    							<input type="button" value="设置批次号" onclick="setBatchNo()"/>
    						</div>	
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
								<input type="text" name="account_type" class="form-control" id="account_type" placeholder="付款账户类型" value="">
							</div>
						</td>
						<td>
							<div class="col-sm-10">
								<select id="selectAccountType" class="form-control" onchange="setAccountType();">
									<option>请选择</option>
									<option value="BASIC">基本户</option>
									<option value="RESERVE">准备金</option>
								</select>
							</div>
						</td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">detail_list: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="detail_list" class="form-control" id="detail_list" placeholder="批量明细信息" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
