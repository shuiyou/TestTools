  ...
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >分账</div>
  	  	...
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../ReceiptSplit" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="receipt_split">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="orig_out_trade_no" class="form-control" id="orig_out_trade_no" placeholder="原商户订单号" value="">
    						</div>					
						</td>
					...
					<tr>
						<td><label class="col-sm-2 control-label">split_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="split_type" class="form-control" id="split_type" placeholder="分账类型，N=分账，R=退分账" value="N">
    						</div>					
						</td>
						<td></td>
					</tr>
