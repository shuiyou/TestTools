...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >存钱罐提现</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundWithdrawAdd" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_withdraw_add">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">arrival_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="arrival_type" class="form-control" id="arrival_type" placeholder="到账类型(默认 TODAY)" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
