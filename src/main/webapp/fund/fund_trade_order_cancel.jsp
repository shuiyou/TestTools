...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >基金撤单</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundTradeOrderCancel" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_trade_order_cancel">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">org_trade_order_no: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="org_trade_order_no" class="form-control" id="org_trade_order_no" placeholder="原交易流水号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">whether_combination: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="whether_combination" class="form-control" id="whether_combination" placeholder="是否是组合订单" value="NO">
                                </div>
                            </td>
                            <td></td>
                        </tr>
