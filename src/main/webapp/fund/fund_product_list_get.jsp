...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >查询基金列表</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundProductListGet" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_product_list_get">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">manager_code: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="manager_code" class="form-control" id="manager_code" placeholder="管理人代码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">fund_status: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="fund_status" class="form-control" id="fund_status" placeholder="基金状态" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">fund_codes: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="fund_codes" class="form-control" id="fund_codes" placeholder="基金代码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">fund_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="fund_type" class="form-control" id="fund_type" placeholder="基金类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">risk_level: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="risk_level" class="form-control" id="risk_level" placeholder="风险等级" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
