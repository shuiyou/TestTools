...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >更新投资者信息</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundMemberInvestorUpdate" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_member_investor_update">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="member_id" class="form-control" id="member_id" placeholder="仓石客户号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">address_info: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="address_info" class="form-control" id="address_info" placeholder="通讯地址信息" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">occupation: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="occupation" class="form-control" id="occupation" placeholder="职业" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">duties: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="duties" class="form-control" id="duties" placeholder="职务" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">income_source: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="income_source" class="form-control" id="income_source" placeholder="收入来源" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">assets_debt_info: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="assets_debt_info" class="form-control" id="assets_debt_info" placeholder="资产/负债情况" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">zip_code: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="zip_code" class="form-control" id="zip_code" placeholder="邮编" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="email" class="form-control" id="email" placeholder="邮箱地址" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">beneficiary: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="beneficiary" class="form-control" id="beneficiary" placeholder="受益人" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
