...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >查询交易日</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundTradeDateGet" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_trade_date_get">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">date_time: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="date_time" class="form-control" id="date_time" placeholder="计算交易日基准时间点" value="yyyymmddhhmmss">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">offset: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="offset" class="form-control" id="offset" placeholder="计算交易日的偏移量" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
