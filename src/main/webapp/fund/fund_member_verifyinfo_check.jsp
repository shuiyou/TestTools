...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >校验用户实名</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundMemberVerifyinfoCheck" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_member_verifyinfo_check">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">identity_no: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="identity_no" class="form-control" id="identity_no" placeholder="投资者证件号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
