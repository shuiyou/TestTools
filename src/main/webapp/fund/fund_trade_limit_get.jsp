...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >查询基金交易限制</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundTradeLimitGet" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_trade_limit_get">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="busin_code" class="form-control" id="busin_code" placeholder="业务代码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">cust_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="cust_type" class="form-control" id="cust_type" placeholder="客户类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">trust_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="trust_type" class="form-control" id="trust_type" placeholder="委托方式" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">other_fund_code: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="other_fund_code" class="form-control" id="other_fund_code" placeholder="转入基金代码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
