...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >基金赎回转申购</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundTradeRedeemAndBuyOrderAdd" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_trade_redeem_and_buy_order_add">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">share_id: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="share_id" class="form-control" id="share_id" placeholder="要转换基金的原基金份额ID" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="button" value="生成商户订单号" onclick="setOutRequestNo()"/>
                                </div>
                            </td>
                        </tr>

                        <tr>
                            <td><label class="col-sm-2 control-label">dest_fund_code: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="dest_fund_code" class="form-control" id="dest_fund_code" placeholder="要转换的目标基金代码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">trade_share: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="trade_share" class="form-control" id="trade_share" placeholder="要转换的份额" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">large_flag: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="large_flag" class="form-control" id="large_flag" placeholder="巨额赎回处理方式" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="overstep_risk_level" class="form-control" id="overstep_risk_level" placeholder="是否同意承受超出风险" value="NO">
                                </div>
                            </td>
                            <td></td>
                        </tr>
