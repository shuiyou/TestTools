...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >提交风险测评调查问卷</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundRiskAnswerSurveyAdd" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_risk_answer_survey_add">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">selections </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="selections" class="form-control" id="selections" placeholder="题目的选项" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
