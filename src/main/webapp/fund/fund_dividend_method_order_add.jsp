...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >修改分红方式</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundDividendMethodOrderAdd" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_dividend_method_order_add">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">dividend_dethod: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="dividend_dethod" class="form-control" id="dividend_dethod" placeholder="分红方式" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
