...
<head>
    ...
    <script type="text/javascript">
        ...
        function setOutRequestNo(){
            var requestTime = document.getElementById('out_request_no');
            requestTime.value = new Date().Format('yyyyMMddHHmmss');
        }

        function setPortfolioApplyNo(){
            var requestTime = document.getElementById('portfolio_apply_no');
            requestTime.value = new Date().Format('yyyyMMddHHmmss');
        }

        function setPortfolioCode(){
            var requestTime = document.getElementById('portfolio_code');
            requestTime.value = new Date().Format('yyyyMMddHHmmss');
        }
...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >一键下单</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FundTradeCombinationOrderAdd" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="fund_trade_combination_order_add">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payment_method_id" class="form-control" id="payment_method_id" placeholder="支付方式ID" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payment_type" class="form-control" id="payment_type" placeholder="支付类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">portfolio_apply_no: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="portfolio_apply_no" class="form-control" id="portfolio_apply_no" placeholder="组合订单号" value="">
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="button" value="生成组合订单号" onclick="setPortfolioApplyNo()"/>
                                </div>
                            </td>
                        </tr>

                        <tr>
                            <td><label class="col-sm-2 control-label">portfolio_code: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="portfolio_code" class="form-control" id="portfolio_code" placeholder="组合代码" value="">
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="button" value="生成组合代码" onclick="setPortfolioCode()"/>
                                </div>
                            </td>
                        </tr>

                        <tr>
                            <td><label class="col-sm-2 control-label">combination_details: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="combination_details" class="form-control" id="combination_details" placeholder="组合明细" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <%--<tr>--%>
                            ...
                            <%--<td>--%>
                                <%--<div class="col-sm-10">--%>
                                    <%--<input type="text" name="fund_code" class="form-control" id="fund_code" placeholder="基金代码" value="">--%>
                                <%--</div>--%>
                            <%--</td>--%>
                            <%--<td></td>--%>
                        <%--</tr>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="risk_notice" class="form-control" id="risk_notice" placeholder="风险警示内容" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="client_ip" class="form-control" id="client_ip" placeholder="用户IP地址" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="mac_address" class="form-control" id="mac_address" placeholder="用户MAC地址" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
