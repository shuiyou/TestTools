...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >创建单笔消费交易接口</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateSingleConsumeTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_single_consume_trade">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_trade_code" class="form-control" id="out_trade_code" placeholder="交易码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payer_identity_id" class="form-control" id="payer_identity_id" placeholder="付款方uid" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">order_title: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="order_title" class="form-control" id="order_title" placeholder="订单标题" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><label class="col-sm-2 control-label">order_desc: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="order_desc" class="form-control" id="order_desc" placeholder="订单详情" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><label class="col-sm-2 control-label">goods_website: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="goods_website" class="form-control" id="goods_website" placeholder="商品网址" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><label class="col-sm-2 control-label">goods_kind: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="goods_kind" class="form-control" id="goods_kind" placeholder="商品种类" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><label class="col-sm-2 control-label">goods_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="goods_type" class="form-control" id="goods_type" placeholder="商品类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
