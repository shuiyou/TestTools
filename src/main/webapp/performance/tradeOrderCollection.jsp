			...
			$.ajax({
				...
				success : function(data) {
					...
					$('#container').highcharts({
						title : {
							text : 'T_TRADE_ORDER Data Collection',
							x : -20
						//center
						},
						subtitle : {
							text : 'T_TRADE_ORDER表每秒落地订单统计',
							x : -20
						},
						xAxis : {
...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		...
		<div id="tradeOrderCollection">
			<div class="h4">T_TRADE_ORDER表订单落地情况查询</div>
					...
					<form target="_blank" class="form-horizontal" role="form"
						...
						<table class="table table-striped">
							<thead>
								...
								<tr>
									<td><label class="col-sm-2 control-label">partnerId：</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="partnerId" class="form-control"
												id="partnerId" placeholder="商户号" value="200003670082">
										</div>
									</td>
									<td></td>
								</tr>
