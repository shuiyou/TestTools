...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >创建个人会员账号</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../PersonalMemberInfoAdd" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="personal_member_info_add">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="login_name_type" class="form-control" id="login_name_type" placeholder="账号的登录名类型(MOBILE/EMAIL/CHARACTER/UID)" value="MOBILE">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="login_name" class="form-control" id="login_name" placeholder="账号的登录名" value="">
    						</div>					
						</td>
						
						<td>
    						<div class="col-sm-10">
    							<input type="button" value="生成账号" onclick="setLoginName()"/>
    						</div>					
						</td>
					</tr>
					
					<tr>
						<td><label class="col-sm-2 control-label">login_pwd: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="login_pwd" class="form-control" id="login_pwd" placeholder="登陆密码" value="123456abc">
    						</div>					
						</td>
						<td></td>
					</tr>
						...
						<tr>
						<td><label class="col-sm-2 control-label">invite_code: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="invite_code" class="form-control" id="invite_code" placeholder="邀请码" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
