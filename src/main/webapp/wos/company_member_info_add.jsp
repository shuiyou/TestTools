			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="company_member_info_add">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="login_name_type" class="form-control" id="login_name_type" placeholder="账号的登录名类型(只支持UID，EMAIL)" value="EMAIL">
    						</div>					
						</td>
						<td></td>
					</tr>
