...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >定期借款列表</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../RegularLoanList" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="regular_loan_list">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">debt_status: </label></td>
						<td>
    						<div class="col-sm-10">
    							<select id="debt_status"  name="debt_status"  class="form-control"   placeholder="借款状态">
    								<option>请选择</option>
    								<option value="SUCCESS" selected="YES" >借款成功</option>
    								<option value="DEBTING" >借款中</option>
    								<option value="FAIL">借款失败</option>
    							</select>
    						</div>					
						</td> 
					</tr>
