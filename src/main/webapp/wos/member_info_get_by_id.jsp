...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >根据会员id查询</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../MemberInfoGetById" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="member_info_get_by_id">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">require_verify_infos: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="require_verify_infos" class="form-control" id="require_verify_infos" placeholder="是否查询会员认证信息，默认N" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
