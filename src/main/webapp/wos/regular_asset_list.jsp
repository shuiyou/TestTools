...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >定期资产列表</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../RegularAssetList" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="regular_asset_list">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">order_column: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="order_column" class="form-control" id="order_column" placeholder="起息日，到期日" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">order_direction: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="order_direction" class="form-control" id="order_direction" placeholder="排序方式" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
						...
						<td>
    						<div class="col-sm-10">
    							<select id="status"  name="status"  class="form-control"   placeholder="资产状态">
    								<option>请选择</option>
    								<option value="RAISEING" selected="YES" >募集中</option>
    								<option value="WAITING_PERFORM" >收款中</option>
    								<option value="SETTLED">已还本付息</option>
    							</select>
    						</div>					
						</td> 
					</tr>
