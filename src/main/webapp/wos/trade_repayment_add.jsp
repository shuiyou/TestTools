...
function show(){
	...
	switch(select.value){
		case 'func':
			...
			billId.value = '2015112600015802';
			amount.value='100.83';
			break;
		case 'real':
			address.value='https://api.wexfin.com/wos/gateway';
			partnerId.value='200011807404';
			memberId.value = '10000000000157';
			billId.value ='2016010700017801';
			amount.value="2.05";
			break;
		default:
			address.value='';
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >还款申请</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../TradeRepaymentAdd" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="trade_repayment_add">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">bill_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="bill_id" class="form-control" id="bill_id" placeholder="账单ID" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="amount" class="form-control" id="amount" placeholder="还款金额" value="10.00">
    						</div>					
						</td>
						<td></td>
					</tr>
