...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >站点公告批量查询</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../SiteNoticeList" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="site_notice_list">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">level: </label></td>
						
						<td>
    						<div class="col-sm-10">
    							<select id="level" class="form-control" name="level">
    								<option value="NORMAL" >普通</option>
    								<option value="HIGHEST">置顶：将处于首页顶部通栏</option>
    							</select>
    						</div>					
						</td> 
					</tr>
