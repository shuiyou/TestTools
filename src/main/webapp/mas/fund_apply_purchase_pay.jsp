...
<script type="text/javascript">
	...
	function setTradeDate() {
		var requestTime = document.getElementById('trade_date');
		requestTime.value = new Date().Format('yyyyMMdd');
	}
...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">申请申购代付</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../FundApplyPurchasePay" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									<td><label class="col-sm-2 control-label">out_batch_no:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="out_batch_no" class="form-control"
												id="out_batch_no" placeholder="批次订单号" value="">
										</div>
									</td>
									<td>
										<div class="col-sm-10">
											<input type="button" value="生成批次订单号"
								...
								<tr>
									<td><label class="col-sm-2 control-label">trade_date:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="trade_date" class="form-control"
												id="trade_date" placeholder="交易日期" value="">
										</div>
									</td>
									<td>
										<div class="col-sm-10">
											<input type="button" value="生成交易日期"
								...
								<tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_inst_code" class="form-control"
												id="fund_inst_code" placeholder="基金公司代码" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">fund_plain_file:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_plain_file" class="form-control"
												id="fund_plain_file" placeholder="监管明文文件" value="">
										</div>
									</td>
									<td></td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">fund_encrypt_file:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_encrypt_file" class="form-control"
												id="fund_encrypt_file" placeholder="监管秘文文件" value="">
										</div>
									</td>
									<td></td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">file_digest:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="file_digest" class="form-control"
												id="file_digest" placeholder="文件摘要" value="">
										</div>
									</td>
									<td></td>
								</tr>
