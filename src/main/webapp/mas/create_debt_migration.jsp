...
<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
     class="container">
    <div id="createMember">
        <div class="h4">债权迁移</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form"
                      name="login" action="../CreateDebtMigration_sh" method="post"
                    ...
                    <table class="table table-striped">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control"
                                           id="service" placeholder="接口名称" value="create_debt_migration">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="goods_id" class="form-control"
                                           id="goods_id" placeholder="债权标的号" value="">
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="button" value="生成交易订单号" onclick="setOut_trade_no()" />
                                </div>
                            </td>
                        </tr>
