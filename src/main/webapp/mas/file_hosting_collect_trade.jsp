...
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript">
            ...
            function setOutBatchNo(){
            var requestTime = document.getElementById('out_batch_no');
            requestTime.value = new Date().Format('yyyyMMddHHmmss');
        }
...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >创建文件代收交易</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../FileHostingCollectTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="file_hosting_collect_trade">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">out_batch_no: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_batch_no" class="form-control" id="out_batch_no" placeholder="交易订单号" value="">
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="button" value="生成交易订单号" onclick="setOutBatchNo()"/>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="user_ip" class="form-control" id="user_ip" placeholder="用户IP地址(user_ip)：" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">file_path: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="file_path" class="form-control" id="file_path" placeholder="已上传到sftp上的文件全路径" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">file_digest: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="file_digest" class="form-control" id="file_digest" placeholder="文件摘要" value="UID">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">total_amount: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="total_amount" class="form-control" id="total_amount" placeholder="总金额" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">total_quantity: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="total_quantity" class="form-control" id="total_quantity" placeholder="总交易数" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_trade_code" class="form-control" id="out_trade_code" placeholder="外部业务码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
