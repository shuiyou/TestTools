...
function setTradeRelatedNo(){
	var requestTime = document.getElementById('trade_related_no');
	requestTime.value = new Date().Format('yyyyMMddHHmmss');
}
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >创建托管代收交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateHostingCollectTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_hosting_collect_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">trade_related_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="trade_related_no" class="form-control" id="trade_related_no" placeholder="相关业务号" value="">
    						</div>					
						</td>
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生产子账户" onclick="setTradeRelatedNo()"/>
    						</div>	
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="goods_id" class="form-control" id="goods_id" placeholder="商户标的号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">payer_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_id" class="form-control" id="payer_id" placeholder="付款用户ID" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">user_fee: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="user_fee" class="form-control" id="user_fee" placeholder="用户手续费" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">account_identity: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="account_identity" class="form-control" id="account_identity" placeholder="账号标志" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">compensation_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="compensation_type" class="form-control" id="compensation_type" placeholder="赔付类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
