						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="extend_param" class="form-control" id="extend_param"
												   placeholder="扩展信息" value="isRsaEncrypt^Y">
										</div>
									</td>
									<td></td>
								</tr>
