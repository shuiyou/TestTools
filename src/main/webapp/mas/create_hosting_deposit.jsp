...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >托管充值</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateHostingDeposit" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_hosting_deposit">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">deposit_close_time: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="deposit_close_time" class="form-control" id="deposit_close_time" placeholder="充值关闭时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
								<input type="text" name="device_id" class="form-control" id="device_id" placeholder="设备号" value="">
							</div>
						</td>
						<td></td>
					</tr>
