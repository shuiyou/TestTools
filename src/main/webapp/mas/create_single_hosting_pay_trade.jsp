...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >创建单笔托管代付交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateSingleHostingPayTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_single_hosting_pay_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成子账户" onclick="setTradeRelatedNo()"/>
    						</div>	
						</td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">user_ip: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="user_ip" class="form-control" id="user_ip" placeholder="用户IP地址" value="10.1.1.27">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_trade_code" class="form-control" id="out_trade_code" placeholder="交易码" value="2001">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">payee_partner_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_partner_id" class="form-control" id="payee_partner_id" placeholder="收款方平台号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">payer_partner_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_partner_id" class="form-control" id="payer_partner_id" placeholder="付款方方平台号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">account_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="account_type" class="form-control" id="account_type" placeholder="收款人账户类型" value="BASIC">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="split_list" class="form-control" id="split_list" placeholder="分账信息列表" value="9214601504^UID^BASIC^2469842137^UID^BASIC^0.50^备注">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">once_withdraw: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="once_withdraw" class="form-control" id="once_withdraw" placeholder="立即提现标志" value="N">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="card_id" class="form-control" id="card_id" placeholder="卡id" value="">
    						</div>					
						</td>
						<td></td>
					</tr>					
