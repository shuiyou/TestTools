...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">赎回重试</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../FundRedeemPayRetry" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									<td><label class="col-sm-2 control-label">orig_outer_trade_no:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="orig_outer_trade_no" class="form-control"
												id="orig_outer_trade_no" placeholder="原交易订单号" value="">
										</div>
									</td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">orig_out_batch_no:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="orig_out_batch_no" class="form-control"
												id="orig_out_batch_no" placeholder="原交易批次号" value="">
										</div>
									</td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">pay_type:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="pay_type" class="form-control"
												id="pay_type" placeholder="代付类型" value="">
										</div>
									</td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">card_id:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="card_id" class="form-control"
												id="card_id" placeholder="卡ID/账户类型" value="">
										</div>
									</td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">redeem_amount:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="redeem_amount" class="form-control"
												id="redeem_amount" placeholder="赎回金额" value="">
										</div>
									</td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">user_ip:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="user_ip" class="form-control"
												id="user_ip" placeholder="" value="1.1.1.1">
										</div>
									</td>
								</tr>
