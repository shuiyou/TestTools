...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >创建预授权申请</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreatePreAuthTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
				...
				<tbody>
					...
					<tr>
						...
						<td></td>
							...
							<tr>
						<td><label class="col-sm-2 control-label">collect_trade_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="collect_trade_type" class="form-control" id="collect_trade_type" placeholder="" value="pre_auth">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="pay_method" class="form-control" id="pay_method" placeholder="支付方式" value="balance^1^BASIC">
    						</div>					
						</td>
						<td></td>
					</tr>
