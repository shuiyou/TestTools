...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >资金托管及时到账交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateSingleHostingInstantTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_single_hosting_instant_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成交易订单号" onclick="setOutTradeNo()"/>
    						</div>	
						</td>
					</tr>
					
					<tr>
						<td><label class="col-sm-2 control-label">out_trade_code: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_trade_code" class="form-control" id="out_trade_code" placeholder="交易码" value="1001">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="summary" class="form-control" id="summary" placeholder="摘要" value="测试">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="trade_close_time" class="form-control" id="trade_close_time" placeholder="交易关闭时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="can_repay_on_failed" class="form-control" id="can_repay_on_failed" placeholder="支付失败后是否可以再次支付Y/N" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">payer_identity_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_identity_id" class="form-control" id="payer_identity_id" placeholder="付款用户ID" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">payer_identity_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_identity_type" class="form-control" id="payer_identity_type" placeholder="付款用户标识类型" value="UID">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_ip" class="form-control" id="payer_ip" placeholder="付款用户IP地址" value="1.1.1.1">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">payer_account_identity: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_account_identity" class="form-control" id="payer_account_identity" placeholder="付款账户标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="pay_method" class="form-control" id="pay_method" placeholder="支付方式" value="online_bank^100.00^TESTBANK,DEBIT,C">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">is_safe_card_support: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="is_safe_card_support" class="form-control" id="is_safe_card_support" placeholder="是否支持安全卡" value="N">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">payee_identity_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_identity_id" class="form-control" id="payee_identity_id" placeholder="收款方" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
						<tr>
						<td><label class="col-sm-2 control-label">payee_identity_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_identity_type" class="form-control" id="payee_identity_type" placeholder="收款方类型" value="UID">
    						</div>					
						</td>
						<td></td>
					</tr>
						<tr>
						<td><label class="col-sm-2 control-label">payee_account_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_account_type" class="form-control" id="payee_account_type" placeholder="收款方账户类型" value="BASIC">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">payee_account_identity: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_account_identity" class="form-control" id="payee_account_identity" placeholder="收款账户标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
                    <tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="split_list" class="form-control" id="split_list" placeholder="分账信息" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="goods_id" class="form-control" id="goods_id" placeholder="标的号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
						<tr>
						<td><label class="col-sm-2 control-label">gift_money: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="gift_money" class="form-control" id="gift_money" placeholder="红包金额" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">relate_out_trade_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="relate_out_trade_no" class="form-control" id="relate_out_trade_no" placeholder="" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">creditor_info_list: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="creditor_info_list" class="form-control" id="creditor_info_list" placeholder="" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">payer_fee: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_fee" class="form-control" id="payer_fee" placeholder="付款方手续费" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">credit_amount: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="credit_amount" class="form-control" id="credit_amount" placeholder="债转金额" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">payee_fee: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_fee" class="form-control" id="payee_fee" placeholder="收款方手续费" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
