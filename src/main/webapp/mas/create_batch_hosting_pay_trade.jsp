...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >创建批量托管代付交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateBatchHostingPayTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_batch_hosting_pay_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成支付请求号" onclick="setOutPayNo()"/>
    						</div>	
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_partner_id" class="form-control" id="payer_partner_id" placeholder="付款方平台号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">trade_list: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="trade_list" class="form-control" id="trade_list" placeholder="交易列表" value="changeMe~9214601504~UID~BASIC~1.00~9214601504^UID^BASIC^2469842137^UID^BASIC^0.85^备注1~还款清偿1~test^true|notify_type^sync$changeMe~9214601504~UID~BASIC~1.00~9214601504^UID^BASIC^2469842137^UID^BASIC^0.85^备注2~还款清偿2~test^true|notify_type^sync">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">notify_method: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="notify_method" class="form-control" id="notify_method" placeholder="通知方式" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
