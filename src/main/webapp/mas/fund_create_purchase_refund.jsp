...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">撤单交易</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../FundCreatePurchaseRefund" method="post"
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												...
												value="fund_create_purchase_refund">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="orig_outer_trade_no" class="form-control"
												id="orig_outer_trade_no" placeholder="原订单号" value="">
										</div>
									</td>
								</tr>
