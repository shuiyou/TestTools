...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">赎回代付查询</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../FundQueryRedeemDetail" method="post"
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												...
												value="fund_query_redeem_detail">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="out_trade_no" class="form-control"
												id="out_trade_no" placeholder="查询订单号" value="">
										</div>
									</td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="out_batch_no" class="form-control"
												id="out_batch_no" placeholder="原批次号" value="">
										</div>
									</td>
								</tr>
