...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >还代偿</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../p2pRepayCompensation" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="p2p_repay_compensation">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="trade_close_time" class="form-control" id="trade_close_time" placeholder="关闭时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">orig_out_trade_no: </label></td>
						<td>
							<div class="col-sm-10">
								<input type="text" name="orig_out_trade_no" class="form-control" id="orig_out_trade_no" placeholder="原代偿商户订单号" value="">
							</div>
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_identity_id" class="form-control" id="payer_identity_id" placeholder="付款方标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div class="col-sm-10">
								<input type="text" name="payer_account_identity" class="form-control" id="payer_account_identity" placeholder="103" value="">
							</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_identity_type" class="form-control" id="payer_identity_type" placeholder="付款方标识类型" value="UID">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="can_repay_on_failed" class="form-control" id="can_repay_on_failed" placeholder="重复支付" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
