...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >创建单笔托管代付到银行卡交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateSingleHostingPayToCardTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_single_hosting_pay_to_card_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">collect_method: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="collect_method" class="form-control" id="collect_method" placeholder="收款方式" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
