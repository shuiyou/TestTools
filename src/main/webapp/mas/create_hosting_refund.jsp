...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >托管退款</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateHostingRefund" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_hosting_refund">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">orig_outer_trade_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="orig_outer_trade_no" class="form-control" id="orig_outer_trade_no" placeholder="原始交易订单号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">refund_amount: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="refund_amount" class="form-control" id="refund_amount" placeholder="退款金额" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">refund_split_strategy: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="refund_split_strategy" class="form-control" id="refund_split_strategy" placeholder="分账策略" value="">
    						</div>					
						</td>
						<td></td>
					</tr>			
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="refund_split_list" class="form-control" id="refund_split_list" placeholder="分账信息列表" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
