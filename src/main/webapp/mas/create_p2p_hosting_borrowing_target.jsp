...
<script type="text/javascript">
	...
	function setOutTradeNo() {
		var requestTime = document.getElementById('goods_id');
		requestTime.value = new Date().Format('yyyyMMddHHmmss');
	}
...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">创建标的(旧版)</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../CreateP2PHostingBorrowingTarget"
						method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
						<table class="table table-striped">
							...
							<tbody>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												...
												value="create_p2p_hosting_borrowing_target">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">goods_id:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="goods_id" class="form-control"
												id="goods_id" placeholder="标的号" value="">
										</div>
									</td>
									<td>
										<div class="col-sm-10">
											<input type="button" value="生成标的号" onclick="setOutTradeNo()" />
										</div>
									</td>
								</tr>

								<tr>
									<td><label class="col-sm-2 control-label">goods_name:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="goods_name" class="form-control"
												id="goods_name" placeholder="标的名称">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="summary" class="form-control"
												id="summary" placeholder="摘要" value="测试">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">annual_yield:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="annual_yield" class="form-control"
												id="annual_yield" placeholder="年化率" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">repay_method:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="repay_method" class="form-control"
												id="repay_method" placeholder="还款方式" value="DEBT_MATURITY">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">debtor_list:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="debtor_list" class="form-control"
												id="debtor_list" placeholder="借款人列表"
												value="$UID^UID^$amount">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">investor_list:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="investor_list" class="form-control"
												id="investor_list" placeholder="投资人列表"
												value="$UID^UID^$amount">
										</div>
									</td>
									<td></td>
								...
								<tr>
									<td><label class="col-sm-2 control-label">total_amount:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="total_amount"
												class="form-control" id="total_amount" placeholder="总金额"
												value="">
										</div>
									</td>
									<td></td>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="begin_date" class="form-control"
												id="begin_date" placeholder="起始时间" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">url:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="url2"
												class="form-control" id="url2"
												placeholder="URL2" value="">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="extend_param" class="form-control"
												id="extend_param" placeholder="扩展参数" value="">
										</div>
									</td>
									<td></td>
								</tr>
