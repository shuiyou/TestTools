...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >托管提现</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateHostingWithdraw" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_hosting_withdraw">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="account_type" class="form-control" id="account_type" placeholder="账户类型" value="BASIC">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="account_identity" class="form-control" id="account_identity" placeholder="账户标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="user_ip" class="form-control" id="user_ip" placeholder="用户IP地址" value="1.1.1.1">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">withdraw_mode: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="withdraw_mode" class="form-control" id="withdraw_mode" placeholder="提现模式" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payto_type" class="form-control" id="payto_type" placeholder="到账类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">withdraw_close_time: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="withdraw_close_time" class="form-control" id="withdraw_close_time" placeholder="提现关闭时间" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
