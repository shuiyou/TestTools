...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">申请赎回代付</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../FundApplyRedeemPay" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									<td><label class="col-sm-2 control-label">detail_file:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="detail_file" class="form-control"
												id="detail_file" placeholder="代付明细文件" value="">
										</div>
									</td>
									<td></td>
								</tr>
