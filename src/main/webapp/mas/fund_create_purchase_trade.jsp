...
<script type="text/javascript">
	...
	function setPurchaseOrderNo() {
		var requestTime = document.getElementById('purchase_order_no');
		requestTime.value = new Date().Format('yyyyMMddHHmmss');
	}
...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">创建申购交易</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../FundCreatePurchaseTrade" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												id="service" placeholder="接口名称"
												value="fund_create_purchase_trade">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">out_trade_no:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="out_trade_no" class="form-control"
												id="out_trade_no" placeholder="交易订单号" value="">
										</div>
									</td>
									<td>
										<div class="col-sm-10">
											<input type="button" value="生成交易订单号"
												onclick="setOutTradeNo()" />
										</div>
									</td>
								</tr>
								<tr>
									<td><label class="col-sm-2 control-label">purchase_order_no:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="purchase_order_no" class="form-control"
												id="purchase_order_no" placeholder="申购流水号" value="">
										</div>
									</td>
									<td>
										<div class="col-sm-10">
											<input type="button" value="生成申购流水号"
												onclick="setPurchaseOrderNo()" />
										</div>
									</td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">payer_id:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="payer_id" class="form-control"
												id="payer_id" placeholder="用户标识信息" value="">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="payer_identity_type" class="form-control"
												id="payer_identity_type" placeholder="用户标识类型" value="UID">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">payer_ip:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="payer_ip" class="form-control"
												id="payer_ip" placeholder="用户IP地址" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">trade_close_time:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="trade_close_time"
												class="form-control" id="trade_close_time"
												placeholder="交易关闭时间" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">can_repay_on_failed:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="can_repay_on_failed"
												class="form-control" id="can_repay_on_failed"
												placeholder="失败后是否再次支付" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">fund_inst_code:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_inst_code"
												class="form-control" id="fund_inst_code"
												placeholder="基金公司代码" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">fund_prod_code:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_prod_code"
												class="form-control" id="fund_prod_code"
												placeholder="基金产品代码" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">fund_prod_type:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_prod_type"
												class="form-control" id="fund_prod_type"
												placeholder="基金产品属性" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">fund_trade_type:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_trade_type"
												class="form-control" id="fund_trade_type"
												placeholder="基金交易类型" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">pay_method:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="pay_method"
												class="form-control" id="pay_method"
												placeholder="" value="online_bank^100.00^SINAPAY,DEBIT,C">
										</div>
									</td>
									<td></td>
								</tr>
