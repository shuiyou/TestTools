...
<script type="text/javascript">
    ...
    function setBid_name() {
        var requestTime = document.getElementById('bid_name');
        requestTime.value = new Date().Format('yyyyMMddHHmmss');
    }
...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">创建标的</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../CreateBidInfo" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="button" value="生成标的名称" onclick="setBid_name()" />
										</div>
									</td>
								</tr>
								<tr>
                                ...
                                <tr>
									<td><label class="col-sm-2 control-label">assure_party_list:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="assure_party_list"
												class="form-control" id="assure_party_list"
												placeholder="担保人列表" value="">
										</div>
									</td>
									<td></td>
								</tr>
