...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >托管交易支付</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../PayHostingTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="pay_hosting_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">outer_trade_no_list: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="outer_trade_no_list" class="form-control" id="outer_trade_no_list" placeholder="商户网站唯一交易订单号集合" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
