...
<script type="text/javascript">
	...
	function setOutAdvanceNo() {
		var requestTime = document.getElementById('out_advance_no');
		requestTime.value = new Date().Format('yyyyMMddHHmmss');
	}
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												id="service" placeholder="接口名称" value="advance_hosting_pay">
										</div>
									</td>
									<td></td>
								</tr>
					...
					<tr>
						...
						<td></td>
								...
								<tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name=out_advance_no class="form-control"
												id="out_advance_no" placeholder="支付推进请求号" value="">
										</div>
									</td>
									<td>
										<div class="col-sm-10">
											<input type="button" value="生成支付推进请求号"
												onclick="setOutAdvanceNo()" />
										</div>
									</td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="ticket" class="form-control"
												id="ticket" placeholder="绑卡时返回的TICKET" value="">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">validate_code:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="validate_code" class="form-control"
												id="validate_code" placeholder="短信验证码" value="">
										</div>
									</td>
									<td></td>
								</tr>
