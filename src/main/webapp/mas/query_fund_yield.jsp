...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">查存钱罐收益率</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../QueryFundYield"
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									<td><label class="col-sm-2 control-label">fund_code:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="fund_code" class="form-control"
												id="fund_code" placeholder="基金代码">
										</div>
									</td>
									<td></td>
								</tr>
