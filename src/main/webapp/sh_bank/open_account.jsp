...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">会员开户接口</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../OpenAccount_sh" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												id="service" placeholder="接口名称" value="open_account">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">request_no:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="request_no" class="form-control"
												id="request_no" placeholder="请求号" value="">
										</div>
									</td>
									<td><div class="col-sm-10"> <input type="button"
										value="生成请求号" onclick="setRequestNo()" />
										</div>
									</td>
								</tr>
