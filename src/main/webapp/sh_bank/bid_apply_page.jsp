...
<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
     class="container">
    <div id="createMember">
        <div class="h4">投标申请</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form"
                      name="login" action="../BidApply_sh" method="post"
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control"
                                           id="service" placeholder="接口名称" value="bid_apply_page">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="identity_id" class="form-control"
                                           id="identity_id" placeholder="客户标识信息" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="identity_type" class="form-control"
                                           id="identity_type" placeholder="客户标识类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
