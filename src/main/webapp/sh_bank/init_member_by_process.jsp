...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">综合创建激活会员</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../InitMemberByProcess_sh" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												id="service" placeholder="接口名称" value="init_member_by_process">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
                                    <td><label class="col-sm-2 control-label">flow_category:
                                    </label></td>
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="flow_category" class="form-control"
                                                id="flow_category" placeholder="流程种类" value="">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="col-sm-2 control-label">member_type:
                                    </label></td>
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="member_type" class="form-control"
                                                id="member_type" placeholder="会员类型" value="">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="col-sm-2 control-label">real_name:
                                    </label></td>
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="real_name" class="form-control"
                                                id="real_name" placeholder="真实姓名" value="">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="col-sm-2 control-label">cert_type:
                                    </label></td>
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="cert_type" class="form-control"
                                                id="cert_type" placeholder="证件类型" value="">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="col-sm-2 control-label">cert_no:
                                    </label></td>
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="cert_no" class="form-control"
                                                id="cert_no" placeholder="证件号码" value="">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="col-sm-2 control-label">account_type:
                                    </label></td>
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="account_type" class="form-control"
                                                id="account_type" placeholder="账户类型" value="">
                                        </div>
                                    </td>
                                </tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">host_role:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="host_role" class="form-control"
												   id="host_role" placeholder="存管角色" value="">
										</div>
									</td>
								</tr>
