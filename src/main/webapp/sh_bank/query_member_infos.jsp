...
<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
     class="container">
    <div id="createMember">
        <div class="h4">查询会员信息</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form"
                      name="login" action="../QueryMemberInfos_sh" method="post"
                    ...
                    <table class="table table-striped">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control"
                                           id="service" placeholder="接口名称" value="query_member_infos">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">query_card_flag:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="query_card_flag" class="form-control"
                                           id="query_card_flag" placeholder="是否查询银行卡标志" value="">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td><label class="col-sm-2 control-label">query_paypwd_set_flag:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="query_paypwd_set_flag" class="form-control"
                                           id="query_paypwd_set_flag" placeholder="查询支付密码设置标志" value="">
                                </div>
                            </td>
                        </tr>
                        <tr>
