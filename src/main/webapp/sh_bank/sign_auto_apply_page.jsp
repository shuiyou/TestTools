...
<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
     class="container">
    <div id="createMember">
        <div class="h4">P2P委托扣款自动签约申请</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form"
                      name="login" action="../SignAutoApply_sh" method="post"
                    ...
                    <table class="table table-striped">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control"
                                           id="service" placeholder="接口名称" value="sign_auto_apply_page">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">quota:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="quota" class="form-control"
                                           id="quota" placeholder="单笔额度" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">day_quota:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="day_quota" class="form-control"
                                           id="day_quota" placeholder="日累计额度" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">auth_type_whitelist:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="auth_type_whitelist" class="form-control"
                                           id="auth_type_whitelist" placeholder="代扣授权类型白名单" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
