...
<body>
    <div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
        class="container">
        <div id="createMember">
            <div class="h4">客户子账号转账</div>
            <div style="width: 800px">
                <div>
                    <form target="_blank" class="form-horizontal" role="form"
                        name="login" action="../AccountFundTransfer_sh" method="post"
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="service" class="form-control"
                                                id="service" placeholder="接口名称" value="account_fund_transfer">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><div class="col-sm-10"> <input type="button"
                                        value="生成交易订单号" onclick="setRequestNo()" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="out_trade_code" class="form-control"
                                                id="out_trade_code" placeholder="交易码" value="">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="payer_identity_id" class="form-control"
                                                id="payer_identity_id" placeholder="付款人用户标识信息" value="">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="payer_identity_type" class="form-control"
                                                id="payer_identity_type" placeholder="付款人标识类型" value="UID">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="payee_identity_id" class="form-control"
                                                id="payee_identity_id" placeholder="收款人用户标识信息" value="">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" name="payee_identity_type" class="form-control"
                                                id="payee_identity_type" placeholder="收款人标识类型" value="UID">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
