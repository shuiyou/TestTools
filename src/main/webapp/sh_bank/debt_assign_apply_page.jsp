...
<head>
    ...
    <script type="text/javascript">
        function show() {
            ...
            switch (select.value) {
                case 'func':
                    address.value='http://10.65.209.181/mas/gateway.do';
...
<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
     class="container">
    <div id="createMember">
        <div class="h4">债券转让申请</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form"
                      name="login" action="../DebtAssignApply_sh" method="post"
                    ...
                    <table class="table table-striped">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control"
                                           id="service" placeholder="接口名称" value="debt_assign_apply_page">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">out_trade_code:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_trade_code" class="form-control"
                                           id="out_trade_code" placeholder="交易业务码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">payer_identity_id:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payer_identity_id" class="form-control"
                                           id="payer_identity_id" placeholder="付款人标识" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">payer_identity_type:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payer_identity_type" class="form-control"
                                           id="payer_identity_type" placeholder="付款人标识类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">payer_account_type:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payer_account_type" class="form-control"
                                           id="payer_account_type" placeholder="付款人账户类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">payee_identity_id:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payee_identity_id" class="form-control"
                                           id="payee_identity_id" placeholder="收款人标识" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">payee_identity_type:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payee_identity_type" class="form-control"
                                           id="payee_identity_type" placeholder="收款人标识类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">payee_account_type:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="payee_account_type" class="form-control"
                                           id="payee_account_type" placeholder="收款人账户类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">amount:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="amount" class="form-control"
                                           id="amount" placeholder="金额" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">gift_money:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="gift_money" class="form-control"
                                           id="gift_money" placeholder="红包金额" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">tr_fee:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="tr_fee" class="form-control"
                                           id="tr_fee" placeholder="手续费" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">tr_share:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="tr_share" class="form-control"
                                           id="tr_share" placeholder="债权" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">tr_yield:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="tr_yield" class="form-control"
                                           id="tr_yield" placeholder="年化收益率" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">tr_int_date:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="tr_int_date" class="form-control"
                                           id="tr_int_date" placeholder="起息日" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">cashdesk_addr_category:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="cashdesk_addr_category" class="form-control"
                                           id="cashdesk_addr_category" placeholder="H5模式" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="extend_param" class="form-control"
                                           id="extend_param" placeholder="扩展信息" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
