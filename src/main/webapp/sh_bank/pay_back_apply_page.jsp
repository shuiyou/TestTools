...
<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
     class="container">
    <div id="createMember">
        <div class="h4">还款申请页面</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form"
                      name="login" action="../PayBackApplyPage_sh" method="post"
                    ...
                    <table class="table table-striped">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control"
                                           id="service" placeholder="接口名称" value="pay_back_apply_page">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">identity_id:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="identity_id" class="form-control"
                                           id="identity_id" placeholder="用户标识信息" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><label class="col-sm-2 control-label">identity_type:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="identity_type" class="form-control"
                                           id="identity_type" placeholder="标识类型" value="UID">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_trade_no" class="form-control"
                                           id="out_trade_no" placeholder="交易订单号">
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-10">
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">user_fee:
                            </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="user_fee" class="form-control"
                                           id="user_fee" placeholder="用户手续费" value="">
                                </div>
                            </td>
                        </tr>
                        <tr>
