...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >OCR获取身份证正反面信息(优化)</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../ValidateIdentityPicNewEncrypt" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="validate_identity_pic_new_encrypt">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file" class="form-control" id="pic_file" placeholder="实名图像文件列表(加密)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file2" class="form-control" id="pic_file2" placeholder="实名图像文件列表(不加密)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>
