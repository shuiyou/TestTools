...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
	<div id="createMember">
		<div class="h4" >企业异常信息查询</div>
		<div style="width: 800px">
			<div>
				<form target="_blank" class="form-horizontal" role="form" name="login" action="../QueryErpErrorInfo" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
					<table class="table table-striped">
						...
						<tr>
							...
							<td>
								<div class="col-sm-10">
									<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_erp_error_info">
								</div>
							</td>
							<td></td>
						</tr>
						...
						<tr>
							<td><label class="col-sm-2 control-label">erp_param: </label></td>
							<td>
								<div class="col-sm-10">
									<input type="text" name="erp_param" class="form-control" id="erp_param" placeholder="企业参数" value="">
								</div>
							</td>
							<td></td>
						</tr>
						...
						<tr>
							<td><label class="col-sm-2 control-label">erp_type: </label></td>
							<td>
								<div class="col-sm-10">
									<input type="text" name="erp_type" class="form-control" id="erp_type" placeholder="企业类型" value="ERP_NAME">
								</div>
							</td>
							<td></td>
						</tr>
