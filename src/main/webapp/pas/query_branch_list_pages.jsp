...
function show(){
	...
	switch(select.value){
		case 'func':
			address.value='http://10.65.209.29:8065/pas/gateway.do';
...
function setRequestNo(){
	var requestTime = document.getElementById('out_request_no');
	requestTime.value = new Date().Format('yyyyMMddHHmmss');
}
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="QueryBranchListPages">
  	  <div class="h4" >银行分支行信息查询接口</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../QueryBranchListPages" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_branch_list_pages">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="version" class="form-control" id="version" placeholder="接口版本" value="PAS_1.0">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="sign_version" class="form-control" id="sign_version" placeholder="签名版本号" value="PAS_1.0">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="encrypt_version" class="form-control" id="encrypt_version" placeholder="加密版本号" value="PAS_1.0">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_request_no" class="form-control" id="out_request_no" placeholder="校验请求号" value="">
    						</div>					
						</td>
						<td>
    						<div class="col-sm-10">
    							<input type="button" value="授权请求号" onclick="setRequestNo()"/>
    						</div>					
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="bank_code" class="form-control" id="bank_code" placeholder="开户行" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">prov_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="prov_id" class="form-control" id="prov_id" placeholder="省份id" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">alike_prov_alias: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="alike_prov_alias" class="form-control" id="alike_prov_alias" placeholder="省份名称" value="">
    						</div>					
						</td>
					</tr>
					
					<tr>
						<td><label class="col-sm-2 control-label">city_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="city_id" class="form-control" id="city_id" placeholder="城市id" value="">
    						</div>					
						</td>
					</tr>
					
					<tr>
						<td><label class="col-sm-2 control-label">alike_city_alias: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="alike_city_alias" class="form-control" id="alike_city_alias" placeholder="城市名称" value="">
    						</div>					
						</td>
					</tr>
					
					<tr>
						<td><label class="col-sm-2 control-label">alike_area_alias: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="alike_area_alias" class="form-control" id="alike_area_alias" placeholder="地区名称" value="">
    						</div>					
						</td>
					</tr>
					
					<tr>
						<td><label class="col-sm-2 control-label">alike_branch_alias: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="alike_branch_alias" class="form-control" id="alike_branch_alias" placeholder="分支行名称" value="">
    						</div>					
						</td>
					</tr>
