...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >账单查询</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../QueryFlowStatis" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_flow_statis">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">startDate: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="startDate" class="form-control" id="startDate" placeholder="查询启始时间" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">endDate: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="endDate" class="form-control" id="erp_type" placeholder="查询结束时间" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        statisticServiceName
                        </tr>



                        <tr>
                            <td><label class="col-sm-2 control-label">statisticServiceName: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="statisticServiceName" class="form-control" id="statisticServiceName" placeholder="待查服务名" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
