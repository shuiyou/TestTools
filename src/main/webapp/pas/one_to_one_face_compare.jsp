...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >一比一人脸比对(尹全旺)</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../OneToOneFaceCompare" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="one_to_one_face_compare">
    						</div>					
						</td>
						<td></td>
					</tr>
				   ...
				   <tr>
                           ...
                           <td>
                               <div class="col-sm-10">
                              	 <textarea name="pic_file_first" class="form-control" id="pic_file_first" placeholder="人脸信息1"></textarea>
                               </div>
                           </td>
                           <td></td>
                       </tr>
				...
				<tr>
				 ...
				 <tr>
                           ...
                           <td>
                               <div class="col-sm-10">
                              	 <textarea name="pic_file_second" class="form-control" id="pic_file_second" placeholder="人脸信息2"></textarea>
                               </div>
                           </td>
                           <td></td>
                       </tr>
