...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >身份授权推进</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../AuthIdentityAdvance" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="auth_identity_advance">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">ticket: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="ticket" class="form-control" id="ticket" placeholder="身份授权时返回的ticket" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">interactive_content: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="interactive_content" class="form-control" id="interactive_content" placeholder="交互性内容" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
