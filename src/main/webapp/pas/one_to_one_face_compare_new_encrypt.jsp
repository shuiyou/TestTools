...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >一比一人脸比对(优化)</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../OneToOneFaceCompareNewEncrypt" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="one_to_one_face_compare_new_encrypt">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="button" value="生成校验请求号" onclick="setRequestNo()"/>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">pic_file_first: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file_first" class="form-control" id="pic_file_first" placeholder="人脸信息1(加密部分)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">pic_file_first2: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file_first2" class="form-control" id="pic_file_first2" placeholder="人脸信息1(未加密部分)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><label class="col-sm-2 control-label">pic_file_second: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file_second" class="form-control" id="pic_file_second" placeholder="人脸信息2(加密部分)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">pic_file_second2: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file_second2" class="form-control" id="pic_file_second2" placeholder="人脸信息2(未加密部分)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>
