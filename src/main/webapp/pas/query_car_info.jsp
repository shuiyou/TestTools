...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="queryLoan">
  	  <div class="h4" >车辆信息查询(尹全旺)</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../QueryCarInfo" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_car_info">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<tr>
						<td><label class="col-sm-2 control-label">licenseNo: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="licenseNo" class="form-control" id="licenseNo" placeholder="车牌号码" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
						...
						<tr>
						<td><label class="col-sm-2 control-label">carType: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="carType" class="form-control" id="carType" placeholder="车辆类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
