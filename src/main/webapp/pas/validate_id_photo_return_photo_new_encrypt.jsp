...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >认证比对返照(优化)</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../ValidateIdPhotoReturnPhotoNewEncrypt" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="validate_id_photo_return_photo_new_encrypt">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">pic_file: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file" class="form-control" id="pic_file" placeholder="图像信息(加密部分)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        <tr>
                            <td><label class="col-sm-2 control-label">pic_file2: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <textarea name="pic_file2" class="form-control" id="pic_file2" placeholder="图像信息(未加密部分)"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>  </tr>
