...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >验证银行卡(翟聪敏)</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../ValidateBankCard" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="validate_bank_card">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_request_no" class="form-control" id="out_request_no" placeholder="验卡请求号" value="">
    						</div>					
						</td>
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成验卡请求号" onclick="setRequestNo()"/>
    						</div>	
						</td>
					...
					<tr>
						<td><label class="col-sm-2 control-label">card_auth_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="card_auth_type" class="form-control" id="card_auth_type" placeholder="鉴权类型" value="3">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">needAdvance: </label></td>
						<td>
							<div class="col-sm-10">
								<input type="text" name="needAdvance" class="form-control" id="needAdvance" placeholder="Y" value="">
							</div>
						</td>
						<td></td>
					</tr>
