...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">个人报告查询(胡晓骅)</div>
			<div style="width: 800px">
				<div>
					<form target="_blank" class="form-horizontal" role="form"
						name="login" action="../QueryReport" method="post"
						...
						<table class="table table-striped">
							...
							<tbody>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="service" class="form-control"
												id="service" placeholder="接口名称" value="query_report">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="version" class="form-control"
												id="version" placeholder="接口版本" value="PAS_1.0">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="sign_version" class="form-control"
												id="sign_version" placeholder="签名版本号" value="PAS_1.0">
										</div>
									</td>
									<td></td>
								</tr>
									...
									<td>
										<div class="col-sm-10">
											<input type="text" name="encrypt_version"
												...
												placeholder="加密版本号" value="PAS_1.0">
										</div>
									</td>
									<td></td>
								</tr>
								...
								<tr>
									<td><label class="col-sm-2 control-label">bank_account_no:
									</label></td>
									<td>
										<div class="col-sm-10">
											<input type="text" name="bank_account_no"
												class="form-control" id="bank_account_no" placeholder="银行卡号"
												value="">
										</div>
									</td>
									<td></td>
