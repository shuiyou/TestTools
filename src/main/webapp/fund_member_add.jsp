			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_activate_member">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">sign: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="sign" class="form-control" id="sign" placeholder="签名" value="UTF-8">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="platform_type" class="form-control" id="platform_type" placeholder="平台类型" value="http://www.baidu.com">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="login_name_type" class="form-control" id="login_name_type" placeholder="登录名类型" value="UID">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="account_name" class="form-control" id="account_name" placeholder="投资者实名" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="phone_no" class="form-control" id="phone_no" placeholder="投资者手机号码" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="email" class="form-control" id="email" placeholder="投资者电子邮箱" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="cert_type" class="form-control" id="cert_type" placeholder="投资者证件类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="password" class="form-control" id="password" placeholder="交易密码" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
