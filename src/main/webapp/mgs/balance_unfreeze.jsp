...
function setOutUnFreezeNo(){
	var requestTime = document.getElementById('out_unfreeze_no');
	requestTime.value = new Date().Format('yyyyMMddHHmmss');
}
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >解冻余额</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../BalanceUnFreeze" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="balance_unfreeze">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">out_unfreeze_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_unfreeze_no" class="form-control" id="out_unfreeze_no" placeholder="解冻订单号">
    						</div>					
						</td>
						<td>
    						<div class="col-sm-10">
    							<input type="button" value="生成解冻订单号" onclick="setOutUnFreezeNo()"/>
    						</div>					
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_freeze_no" class="form-control" id="out_freeze_no" placeholder="原冻结订单号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
