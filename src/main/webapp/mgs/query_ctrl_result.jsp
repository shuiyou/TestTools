...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >查询冻结解冻结果</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../QueryCtrlResult" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_ctrl_result">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">out_ctrl_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_ctrl_no" class="form-control" id="out_ctrl_no" placeholder="冻结解冻订单号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>	
