...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >冻结余额</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../BalanceFreeze" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="balance_freeze">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">out_freeze_no: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_freeze_no" class="form-control" id="out_freeze_no" placeholder="冻结订单号">
    						</div>					
						</td>
						<td>
    						<div class="col-sm-10">
    							<input type="button" value="生成冻结订单号" onclick="setOutFreezeNo()"/>
    						</div>					
						</td>
					</tr>	
					...
					<tr>
						...
						</td><%@ page language="java" contentType="text/html; charset=UTF-8"
									  pageEncoding="UTF-8"%>
						<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
						<%@ include file="/head.jsp"%>
						<html>
