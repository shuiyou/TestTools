...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >我的银行卡</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../WebBindingBankCard" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="web_binding_bank_card">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="cert_no" class="form-control" id="cert_no" placeholder="身份证信息" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						<td><label class="col-sm-2 control-label">could_bind: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="could_bind" class="form-control" id="could_bind" placeholder="允许绑定银行卡" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">could_unbind: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="could_unbind" class="form-control" id="could_unbind" placeholder="允许删除银行卡" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">template: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="template" class="form-control" id="template" placeholder="定制模板" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
