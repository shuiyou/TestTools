...
function setRequestNo(){
	var requestNo = document.getElementById('request_no');
	requestNo.value = new Date().Format('yyyyMMddHHmmss');
}
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >验证支付密码重定向</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../ValidatePayPassword" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="validate_pay_password">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="request_no" class="form-control" id="request_no" placeholder="交易订单号" value="">
    						</div>					
						</td>
						<td>
    						<div class="col-sm-10">
    							<input type="button" value="生成请求订单号" onclick="setRequestNo()"/>
    						</div>					
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="cashdesk_addr_category" class="form-control" id="cashdesk_addr_category" placeholder="MOBILE" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
