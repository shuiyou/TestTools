...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >综合初始化会员</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../InitMemberByProcess" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="init_member_by_process">
    						</div>					
						</td>
						<td></td>
					</tr>
                    ...
                    <tr>
						<td><label class="col-sm-2 control-label">flow_category: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="flow_category" class="form-control" id="flow_category" placeholder="流程种类" value="">
    						</div>					
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
    							<input type="button" value="生成UID" onclick="setUid()"/>
    						</div>	
						</td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="identity_type" class="form-control" id="identity_type" placeholder="标识类型" value="UID">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="member_type" class="form-control" id="member_type" placeholder="会员类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">real_name: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="real_name" class="form-control" id="real_name" placeholder="真实姓名" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="cert_type" class="form-control" id="cert_type" placeholder="证件类型" value="IC">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="account_type" class="form-control" id="account_type" placeholder="开户类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">withhold_kind: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="withhold_kind" class="form-control" id="withhold_kind" placeholder="委托代扣种类" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
						...
						<td></td>
										...
										<tr>
						<td><label class="col-sm-2 control-label">withhold_quota: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="withhold_quota" class="form-control" id="withhold_quota" placeholder="单笔额度" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
										...
										<tr>
						<td><label class="col-sm-2 control-label">withhold_day_quota: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="withhold_day_quota" class="form-control" id="withhold_day_quota" placeholder="日累计额度" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
															...
															<tr>
						<td><label class="col-sm-2 control-label">adv_token: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="adv_token" class="form-control" id="adv_token" placeholder="token" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
																				...
																				<tr>
						<td><label class="col-sm-2 control-label">validate_code: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="validate_code" class="form-control" id="validate_code" placeholder="验证码" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
