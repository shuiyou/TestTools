...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >查询用户安全信息认证</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../QuerySecurityInfo" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_security_info">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">security_kpi_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="security_kpi_type" class="form-control" id="security_kpi_type" placeholder="安全认证类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
