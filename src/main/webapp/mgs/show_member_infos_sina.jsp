...
function setOutFreezeNo(){
	var requestTime = document.getElementById('out_freeze_no');
	requestTime.value = new Date().Format('yyyyMMddHHmmss');
}
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >sina页面展示商户信息</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../ShowMemberInfosSina" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="show_member_infos_sina">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">resp_method: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="resp_method" class="form-control" id="resp_method" placeholder="返回方式" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">default_page: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="default_page" class="form-control" id="default_page" placeholder="默认展示页面" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">hide_pages: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="hide_pages" class="form-control" id="hide_pages" placeholder="隐藏页面" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">templet_custom: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="templet_custom" class="form-control" id="templet_custom" placeholder="定制化模板配置" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">single_custom: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="single_custom" class="form-control" id="single_custom" placeholder="单项定制化配置" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="cashdesk_addr_category" class="form-control" id="cashdesk_addr_category" placeholder="MOBILE打开H5" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
