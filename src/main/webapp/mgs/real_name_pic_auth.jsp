...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >实名图像实时认证</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../RealNamePicAuth" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="real_name_pic_auth">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">pic_file_list: </label></td>
                            <td>
                                <div class="col-sm-10">
                               	 <textarea name="pic_file_list" class="form-control" id="pic_file_list" placeholder="实名图像文件列表"></textarea>
                                </div>
                            </td>
                            <td></td>
                        </tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="client_ip" class="form-control" id="client_ip" placeholder="客户端IP" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
