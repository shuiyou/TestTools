...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >绑定银行卡（上海，华瑞）</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../PageBindingBankCard" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="col-sm-10">
								<input type="text" name="cashdesk_addr_category" class="form-control" id="cashdesk_addr_category" placeholder="收银台地址类型" value="">
							</div>
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">real_neme: </label></td>
						<td>
							<div class="col-sm-10">
								<input type="text" name="real_neme" class="form-control" id="real_neme" placeholder="真实姓名">
							</div>
						</td>
						<td></td>
					</tr>
						...
						<td>
							<div class="col-sm-10">
								<input type="text" name="cert_no" class="form-control" id="cert_no" placeholder="身份证号码">
							</div>
						</td>
						<td></td>
					</tr>
