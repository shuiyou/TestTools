...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >绑定认银行卡</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../BindingBankCard" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						<td><label class="col-sm-2 control-label">verify_mode: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="verify_mode" class="form-control" id="verify_mode" placeholder="认证方式" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
