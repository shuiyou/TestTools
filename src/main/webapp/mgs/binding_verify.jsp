...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >绑定认证信息</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../BindingVerify" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="binding_verify">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">verify_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="verify_type" class="form-control" id="verify_type" placeholder="认证类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">verify_entity: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="verify_entity" class="form-control" id="verify_entity" placeholder="认证内容" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
