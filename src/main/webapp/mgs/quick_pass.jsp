  ...
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >闪付</div>
  	  	...
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../QuickPass" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="quick_pass">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">cancel_url: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="cancel_url" class="form-control" id="cancel_url" placeholder="系统异步回调" value="http://www.baidu.com">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="device_id" class="form-control" id="device_id" placeholder="" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
