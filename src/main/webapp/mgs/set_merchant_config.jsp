...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="createMember">
        <div class="h4" >商户跟新修改ACS配置</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../SetMerchantConfig" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="set_merchant_config">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">config_key: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="config_key" class="form-control" id="config_key" placeholder="配置参数名称" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">config_value: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="config_value" class="form-control" id="config_value" placeholder="配置参数内容" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
