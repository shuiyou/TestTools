...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="SmerchantUrlGet">
  	  <div class="h4" >获取子商户链接</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../SmerchantUrlGet" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="smerchant_url_get">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">url_type: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="url_type" class="form-control" id="url_type" placeholder="链接类型" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
