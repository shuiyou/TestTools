...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >申请经办人信息</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../SmtFundAgentBuy" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="smt_fund_agent_buy">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">agent_name: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="agent_name" class="form-control" id="agent_name" placeholder="经办人姓名" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="license_no" class="form-control" id="license_no" placeholder="经办人身份证" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">license_type_code: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="license_type_code" class="form-control" id="license_type_code" placeholder="证件类型" value="ID">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">agent_mobile: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="agent_mobile" class="form-control" id="agent_mobile" placeholder="经办人手机号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="email" class="form-control" id="email" placeholder="经办人邮箱" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
