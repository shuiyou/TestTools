...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >查询企业会员信息</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../QueryMemberInfos" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="query_member_infos">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="is_mask" class="form-control" id="is_mask" placeholder="是否掩码返回敏感信息" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
