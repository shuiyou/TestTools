...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="CreateInsureTrade">
        <div class="h4" >收单退款</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../CrossRefund" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="cross_refund">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_trade_no" class="form-control" id="out_trade_no" placeholder="支付请求号" value="">
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-10">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="orig_out_trade_no" class="form-control" id="orig_out_trade_no" placeholder="原始订单号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
