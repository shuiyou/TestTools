...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="CreateSurrenderTrade">
  	  <div class="h4" >创建退保交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateSurrenderTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_surrender_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="out_pay_no" class="form-control" id="out_pay_no" placeholder="交易订单号" value="">
    						</div>					
						</td>
						<td>
							<div class="col-sm-10">
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="orig_outer_trade_no" class="form-control" id="orig_outer_trade_no" placeholder="原投保订单号" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="amount" class="form-control" id="amount" placeholder="退保总金额" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="user_ip" class="form-control" id="user_ip" placeholder="用户ip" value="1.1.1.1">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						<td><label class="col-sm-2 control-label">surrender_detail: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="surrender_detail" class="form-control" id="surrender_detail" placeholder="退保明细" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
