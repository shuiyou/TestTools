...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="CreateInsureTrade">
  	  <div class="h4" >创建投保交易</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../CreateInsureTrade" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="create_insure_trade">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_identity_id" class="form-control" id="payer_identity_id" placeholder="付款方用户标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_identity_type" class="form-control" id="payer_identity_type" placeholder="付款方用户标识类型" value="UID">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payer_ip" class="form-control" id="payer_ip" placeholder="付款用户ID" value="1.1.1.1">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="amount" class="form-control" id="amount" placeholder="投保总金额" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_identity_id" class="form-control" id="payee_identity_id" placeholder="收款用户标识" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_identity_type" class="form-control" id="payee_identity_type" placeholder="收款用户标识类型" value="EMAIL">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="payee_account_type" class="form-control" id="payee_account_type" placeholder="收款方账户类型" value="ENSURE">
    						</div>					
						</td>
						<td></td>
					</tr>
