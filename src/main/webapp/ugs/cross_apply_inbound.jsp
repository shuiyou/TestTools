...
<head>
    ...
    <script type="text/javascript">
        ...
        function setIssuedType() {
            var issuedtype = document.getElementById('selectIsType');
            var selectedtype = document.getElementById('issued_type');
            switch(issuedtype.value){
                case 'fundInbound':
                    selectedtype.value='0';
                    break;
                case 'acquiringSettledRefund':
                    selectedtype.value='1';
                    break;
                case 'settleToAccount':
...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="CreateInsureTrade">
        <div class="h4" >申请入境下发</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../CrossApplyInbound" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="cross_apply_inbound">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">batch_date: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="batch_date" class="form-control" id="batch_date" placeholder="批次日期格式(yyyyMMdd)" value="">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_batch_no" class="form-control" id="out_batch_no" placeholder="批次号(3位数字序列号)" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">issued_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="issued_type" class="form-control" id="issued_type" placeholder="下发类型" value="">
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-10">
                                    <div class="col-sm-10">
                                        <select id="selectIsType" class="form-control" onchange="setIssuedType();">
                                            <option>请选择</option>
                                            <option value="fundInbound">出款下发</option>
                                            <option value="acquiringSettledRefund">收单已结算资金退款</option>
                                            <option value="settleToAccount">结算到基本户</option>
                                        </select>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="file_digest" class="form-control" id="file_digest" placeholder="文件摘要" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">file_password: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="file_password" class="form-control" id="file_password" placeholder="文件压缩包密码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
