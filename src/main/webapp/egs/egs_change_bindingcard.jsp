...
function show(){
	...
	switch(select.value){
		case 'func':
			address.value='http://10.65.209.29:8082/egs/gateway.do';
			partnerId.value='200003670082';
			break;
		case 'test':
			address.value='https://testgate.pay.sina.com.cn/egs/gateway.do';
			partnerId.value='200005348948';
			break;
		case 'real':
			address.value='https://gate.pay.sina.com.cn/egs/gateway.do';
...
<body>
  <div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
  	<div id="createMember">
  	  <div class="h4" >EGS换绑卡通知</div>
  	  	<div style="width: 800px">
  	  	<div>
  	      <form target="_blank" class="form-horizontal" role="form" name="login" action="../EgsChangeBindingCard" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="egs_change_bindingcard">
    						</div>					
						</td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="sign_version" class="form-control" id="sign_version" placeholder="签名版本号" value="200008281298_1.0">
    						</div>					
						</td>
						<td></td>
					</tr>
				    ...
				    <tr>
						<td><label class="col-sm-2 control-label">orig_card_id: </label></td>
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="orig_card_id" class="form-control" id="orig_card_id" placeholder="解绑卡" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
				    <tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="card_id" class="form-control" id="card_id" placeholder="新绑卡" value="">
    						</div>					
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
    						<div class="col-sm-10">
    							<input type="text" name="client_ip" class="form-control" id="client_ip" placeholder="客户端IP" value="10.1.1.12">
    						</div>					
						</td>
						<td></td>
					</tr>
