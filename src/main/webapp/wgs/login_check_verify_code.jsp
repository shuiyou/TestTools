...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="LoginCheckVerifyCode">
        <div class="h4" >校验登陆验证码</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../LoginCheckVerifyCode" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="Login.CheckVerifyCode">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="device_identity" class="form-control" id="device_identity" placeholder="设备唯一标识" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">verify_code: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="verify_code" class="form-control" id="verify_code" placeholder="短信验证码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
