...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="LoginSendVerfiyCode">
        <div class="h4" >basic发送验证码</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../BasicSendVerifyCode" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="Basic.SendVerifyCode">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">send_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="send_type" class="form-control" id="send_type" placeholder="send_type" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td> <label class="col-sm-2 control-label">scene:</label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="scene" class="form-control" id="scene" placeholder="场景" value="">
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-10">
                                    <select id="selectScene" class="form-control" onchange="scene();">
                                        <option>请选择</option>
                                        <option value="RESET_PASSWORD">重置密码</option>
                                        <option value="CERTIFY">认证</option>
                                        <option value="BIND_CARD">绑卡</option>
                                        <option value="CHECK_PASSWORD">验证登陆密码</option>
