    ...
    <script type="text/javascript">
        ...
        function chosen() {
            ...
            switch(Cservice.value) {
                case 'SavingPot.DepositDetail':
                    service.value = 'SavingPot.DepositDetail';
                    break;
                case 'SavingPot.WithdrawDetail':
                    service.value = 'SavingPot.WithdrawDetail';
                    break;
                default:
                    service.value = '';
                    break;
...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="SavingPotDepositAndWithdrawDetail">
        <div class="h4" >充值订单详情/提现详情</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../SavingPotDepositAndWithdrawDetail" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <select id="chooseService" class="form-control" onchange="chosen();">
                                        <option>请选择</option>
                                        <option value="SavingPot.DepositDetail">充值订单详情</option>
                                        <option value="SavingPot.WithdrawDetail">提现详情</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="out_trade_no" class="form-control" id="out_trade_no" placeholder="充值提现订单号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
