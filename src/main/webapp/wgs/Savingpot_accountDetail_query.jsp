...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="SavingPotAccountDetailQuery">
        <div class="h4" >预计收益</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../SavingPotAccountDetailQuery" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="SavingPot.AccountDetail.Query">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">trade_type: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="trade_type" class="form-control" id="trade_type" placeholder="交易类型" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="page_no" class="form-control" id="page_no" placeholder="页码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="page_size" class="form-control" id="page_size" placeholder="页码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
