    ...
    <script type="text/javascript">
        ...
        function chosen() {
            ...
            switch(Cservice.value) {
                case 'SavingPot.EstimateYield':
                    service.value = 'SavingPot.EstimateYield';
                    break;
                case 'SavingPot.Deposit':
                    service.value = 'SavingPot.Deposit';
                    break;
                case 'SavingPot.Withdraw':
                    service.value = 'SavingPot.Withdraw';
                    break;
                default:
                    service.value = '';
                    break;
...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="SavingPotEstimateYield">
        <div class="h4" >预计收益/存钱罐充值/存钱罐提现</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../SavingPotEstimateYield" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <select id="chooseService" class="form-control" onchange="chosen();">
                                        <option>请选择</option>
                                        <option value="SavingPot.EstimateYield">预计收益</option>
                                        <option value="SavingPot.Deposit">存钱罐充值</option>
                                        <option value="SavingPot.Withdraw">存钱罐提现</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
