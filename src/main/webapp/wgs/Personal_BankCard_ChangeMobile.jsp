...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="PersonalBankCardChangeMobile">
        <div class="h4" >更换银行预留手机号</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../PersonalBankCardChangeMobile" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="Personal.BankCard.ChangeMobile">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="card_mobile" class="form-control" id="card_mobile" placeholder="新银行预留手机号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
