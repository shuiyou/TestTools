    ...
    <script type="text/javascript">
        ...
        function chosen() {
            ...
            switch(Cservice.value) {
                case 'Basic.VersionCheck':
                    service.value = 'Basic.VersionCheck';
                    break;
                case 'Basic.TouchAccessToken':
                    service.value = 'Basic.TouchAccessToken';
                    break;
                default:
                    service.value = '';
                    break;
...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="LoginSendVerfiyCode">
        <div class="h4" >获取最新版本/延期访问令牌</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../BasicVersionCheck" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <select id="chooseService" class="form-control" onchange="chosen();">
                                        <option>请选择</option>
                                        <option value="Basic.VersionCheck">获取最新版本</option>
                                        <option value="Basic.TouchAccessToken">延期访问令牌</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
