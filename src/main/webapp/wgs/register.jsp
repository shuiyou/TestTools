...
<head>
    ...
    <title>注册</title>
    <script type="text/javascript" scr="https://cdn.bootcss.com/jquery/3.2.1/core.js">
        function show(){
        ...
        function getToken() {
            var url = './/RegisterGetLoginSalt';
            var p = document.getElementById('url');
            var m = document.getElementById('mobile');
            var biz = '{"mobile":"' + m.value + '","scene":"LOGIN","send_type":"SMS"}';
            $('#form').submit();
            $.ajax({
                url:url,
                type:"get",
               ...
               data:{
                    paltform:p.value,
                   service:"Login.SendVerifyCode",
                   version: "1.0.0",
                   biz_content: biz,
                   
                },
                    success:function(data){
                    $("#register_token").value=data.verify_token;
               },
...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="Register">
        ...
        <div style="width: 800px">
            <div>
                <form id="form" target="_blank" class="form-horizontal" role="form" name="login" action="../Register" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="Register">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">register_token: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="register_token" class="form-control" id="register_token" placeholder="注册令牌" value="">
                                </div>
                            </td>
                            <td>
                                <input type="button" id ="123" value="获取registen—token" onclick="getToken()"/>
                            </td>
                            <td></td>
