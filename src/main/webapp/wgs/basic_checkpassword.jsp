...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="LoginSendVerfiyCode">
        <div class="h4" >验证登陆密码</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../BasicCheckPassword" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="Basic.CheckPassword">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="salt_id" class="form-control" id="salt_id" placeholder="salt_id" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
