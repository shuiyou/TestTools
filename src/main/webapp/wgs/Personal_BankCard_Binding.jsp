...
<div style="position: relative;margin-top: 50PX;margin-bottom: 50PX" class="container">
    <div id="PersonalBankCardBinding">
        <div class="h4" >绑定银行卡</div>
        <div style="width: 800px">
            <div>
                <form target="_blank" class="form-horizontal" role="form" name="login" action="../PersonalBankCardBinding" method="post" accept-charset="utf-8" onsubmit="return checkUrl();">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="service" class="form-control" id="service"  placeholder="接口名称" value="Personal.BankCard.Binding">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">card_no: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="card_no" class="form-control" id="card_no" placeholder="银行卡号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="bank_code" class="form-control" id="bank_code" placeholder="银行编码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">card_mobile: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="card_mobile" class="form-control" id="card_mobile" placeholder="银行预留手机号" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">valid_period: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="valid_period" class="form-control" id="valid_period" placeholder="有效期" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td><label class="col-sm-2 control-label">safe_code: </label></td>
                            <td>
                                <div class="col-sm-10">
                                    <input type="text" name="safe_code" class="form-control" id="safe_code" placeholder="安全码" value="">
                                </div>
                            </td>
                            <td></td>
                        </tr>
