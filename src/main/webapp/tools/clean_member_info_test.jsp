...
<body>
	<div style="position: relative; margin-top: 50PX; margin-bottom: 50PX"
		class="container">
		<div id="createMember">
			<div class="h4">清除会员信息(联调)</div>
			<div class="h6">注意:使用手机号或者邮箱名称来清除会员信息时, 所有绑定了所输入的邮箱或手机的会员的相应的信息都会被清除, 若想防止误伤请使用UID进行会员信息数据清除!</div>
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th>
										<div class="col-sm-10">请选择需要清除的信息</div>
									</th>
									<th>
