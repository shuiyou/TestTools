...
import com.mas.bean.FundQueryPurchaseRefundBean;
import com.mas.bean.MasBaseBean;
@Controller
public class FundQueryPurchaseRefund extends HttpServlet{
	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "FundQueryPurchaseRefund")
	public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
			@ModelAttribute("fcprBean") FundQueryPurchaseRefundBean fcprBean,
