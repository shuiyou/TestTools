...
import com.mas.bean.FundApplyPurchasePayBean;
import com.mas.bean.MasBaseBean;
@Controller
public class FundApplyPurchasePay extends HttpServlet {
	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "FundApplyPurchasePay")
	public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
			@ModelAttribute("fcprBean") FundApplyPurchasePayBean fcprBean, HttpServletRequest request,
		...
		if (!fcprBean.getFund_inst_code().isEmpty()) {
			inputString.append(",fund_inst_code=" + fcprBean.getFund_inst_code());
		}
