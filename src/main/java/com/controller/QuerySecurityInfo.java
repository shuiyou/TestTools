...
import com.mgs.bean.QuerySecurityInfoBean;
 ...
 */
@Controller
public class QuerySecurityInfo extends HttpServlet {
    ...
    @RequestMapping(value = "QuerySecurityInfo")
    public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
                       @ModelAttribute("qvBean") QuerySecurityInfoBean qvBean,
        ...
        if (!qvBean.getSecurity_kpi_type().isEmpty()) {
            inputString.append(",security_kpi_type=" + qvBean.getSecurity_kpi_type());
        }
