 ...
 */
@Controller
public class CreateBidInfo extends HttpServlet {
	...
	public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
		...
		if (!cbiBean.getAssure_party_list().isEmpty()) {
			inputString.append(",assure_party_list=" + cbiBean.getAssure_party_list());
		}
