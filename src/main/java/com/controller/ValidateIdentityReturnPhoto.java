...
import com.pas.bean.ValidateIdentityReturnPhotoBean;

/**
 * @author YQW:
 * @version 创建时间：2017年4月28日 下午3:20:10 类说明
 */
@Controller
public class ValidateIdentityReturnPhoto extends HttpServlet{
  
    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "ValidateIdentityReturnPhoto")
    public void doPost(@ModelAttribute("pasBaseBean") PasBaseBean pasBaseBean,
	    @ModelAttribute("vbcBean") ValidateIdentityReturnPhotoBean vbcBean,
