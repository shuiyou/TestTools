...
import com.mas.bean.CreatePreAuthTradeBean;
 ...
 */
@Controller
public class CreatePreAuthTrade extends HttpServlet {
	...
	@RequestMapping(value = "CreatePreAuthTrade")
	public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
			@ModelAttribute("chctBean") CreatePreAuthTradeBean chctBean,
		...
		if (!chctBean.getCollect_trade_type().isEmpty()) {
			inputString.append(",collect_trade_type=" + chctBean.getCollect_trade_type());
		}
