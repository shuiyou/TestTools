...
import com.mgs.bean.QueryMerchantConfigBean;
 ...
 */
@Controller
public class QueryMerchantConfig extends HttpServlet {
	...
	@RequestMapping(value = "QueryMerchantConfig")
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("srnBean") QueryMerchantConfigBean srnBean,
		...
		if (!srnBean.getConfig_key().isEmpty()) {
			inputString.append(",config_key=" + srnBean.getConfig_key());
		}
