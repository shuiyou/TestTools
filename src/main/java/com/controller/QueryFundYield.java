...
import com.mas.bean.QueryFundYieldBean;
 ...
 */
@Controller
public class QueryFundYield extends HttpServlet {
	...
	@RequestMapping(value = "QueryFundYield")
	public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
			@ModelAttribute("chwBean") QueryFundYieldBean chwBean,
		...
		if (!chwBean.getFund_code().isEmpty()) {
			inputString.append(",fund_code=" + chwBean.getFund_code());
		}
