...
import com.pas.bean.ValidateIdPhotoReturnPhotoBean;


@Controller
public class ValidateIdPhotoReturnPhoto extends HttpServlet{

    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "ValidateIdPhotoReturnPhoto")
    public void doPost(@ModelAttribute("pasBaseBean") PasBaseBean pasBaseBean,
	    @ModelAttribute("vbcBean") ValidateIdPhotoReturnPhotoBean vbcBean,
	...
	//if (!vbcBean.getPic_file().isEmpty()) {
	    inputString.append(",pic_file=" + vbcBean.getPic_file());
	//}
	...
	if (!vbcBean.getPic_file().isEmpty()) {
	    vbcBean.setEncodeString(tool.removeFromString(
		    ...
		    "pic_file")
		    + "&pic_file="
		    + tool.textEncode(vbcBean.getPic_file(), "UTF-8"));
	}
