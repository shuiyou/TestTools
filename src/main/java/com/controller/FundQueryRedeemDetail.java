...
import com.mas.bean.FundQueryRedeemDetailBean;
import com.mas.bean.MasBaseBean;

@Controller
public class FundQueryRedeemDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "FundQueryRedeemDetail")
	public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
			@ModelAttribute("fqptBean") FundQueryRedeemDetailBean fqptBean, HttpServletRequest request,
		...
		if (!fqptBean.getOut_batch_no().isEmpty()) {
			inputString.append(",out_batch_no=" + fqptBean.getOut_batch_no());
		}
