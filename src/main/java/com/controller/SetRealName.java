...
import com.mgs.bean.SetRealNameBean;
 ...
 */
@Controller
public class SetRealName extends HttpServlet {
	...
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("srnBean") SetRealNameBean srnBean,
		...
		if (!srnBean.getNeed_confirm().isEmpty()) {
			inputString.append(",need_confirm=" + srnBean.getNeed_confirm());
		}
