...
import com.b2c.bean.QueryB2cSingleOrderBean;
 ...
 */
@Controller
public class QueryB2cSingleOrder extends HttpServlet {
	...
	@RequestMapping(value = "QueryB2cSingleOrder")
	public void doPost(@ModelAttribute("b2cBaseBean") B2CBaseBean b2cBaseBean,
			@ModelAttribute("qrBean") QueryB2cSingleOrderBean qrBean,
