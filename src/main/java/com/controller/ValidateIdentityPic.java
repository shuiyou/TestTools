...
import com.pas.bean.ValidateIdentityPicBean;

@Controller
public class ValidateIdentityPic extends HttpServlet {

    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "ValidateIdentityPic")
    public void doPost(@ModelAttribute("pasBaseBean") PasBaseBean pasBaseBean,
	    @ModelAttribute("vbcBean") ValidateIdentityPicBean vbcBean,
