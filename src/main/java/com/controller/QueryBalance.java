...
import com.mgs.bean.QueryBalanceBean;
...
public class QueryBalance extends HttpServlet {
	...
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("qbBean") QueryBalanceBean qbBean,
		...
		if (!qbBean.getIdentity_id().isEmpty()) {
			inputString.append(",identity_id=" + qbBean.getIdentity_id());
		}
		if (!qbBean.getIdentity_type().isEmpty()) {
			inputString.append(",identity_type=" + qbBean.getIdentity_type());
		}
		if (!qbBean.getAccount_type().isEmpty()) {
			inputString.append(",account_type=" + qbBean.getAccount_type());
		}
		if (!qbBean.getExtend_param().isEmpty()) {
			inputString.append(",extend_param=" + qbBean.getExtend_param());
		}
		if (!qbBean.getAccount_identity().isEmpty()) {
			inputString.append(",account_identity=" + qbBean.getAccount_identity());
		}
		...
		String requestString = qbBean.getEncodeString() + "&sign="
