...
import com.ugs.bean.CrossQueryTradeBean;
 ...
 */
@Controller
public class CrossQueryTrade extends HttpServlet
{
	/**
	 *
	 */
	...
	@RequestMapping(value = "CrossQueryTrade")
	public void doPost(@ModelAttribute("ugsBaseBean") UgsBaseBean ugsBaseBean,
			@ModelAttribute("cqtBean") CrossQueryTradeBean cqtBean,
			...
			throws IOException, ServletException
	{
		...
		if (!cqtBean.getOut_trade_no().isEmpty()) {
			biz.append("\"out_trade_no\":\"" + cqtBean.getOut_trade_no()+ "\",");
		}
		...
		cqtBean.setEncodeString(sortString);

		String requestString = cqtBean.getEncodeString().replaceAll(
				"replaceFlag", ",")
				+ "&sign=" + sign;
