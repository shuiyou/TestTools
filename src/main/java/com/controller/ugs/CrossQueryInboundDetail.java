...
import com.ugs.bean.CrossQueryInboundDetailBean;
 ...
 */
@Controller
public class CrossQueryInboundDetail extends HttpServlet
{
	/**
	 *
	 */
	...
	@RequestMapping(value = "CrossQueryInboundDetail")
	public void doPost(@ModelAttribute("ugsBaseBean") UgsBaseBean ugsBaseBean,
			@ModelAttribute("cqidBean") CrossQueryInboundDetailBean cqidBean,
			...
			throws IOException, ServletException
	{
		...
		if (!cqidBean.getOut_trade_no().isEmpty()) {
			biz.append("\"out_trade_no\":\"" + cqidBean.getOut_trade_no()+ "\",");
		}
		...
		cqidBean.setEncodeString(sortString);
		String requestString = cqidBean.getEncodeString().replaceAll(
				"replaceFlag", ",")
				+ "&sign=" + sign;
