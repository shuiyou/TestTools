 ...
 */
@Controller
public class CreateActivateMember extends HttpServlet {
	...
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("camBean") CreateActivateMemberBean camBean,
		...
		if (!camBean.getHost_role().isEmpty()) {
			inputString.append(",host_role=" + camBean.getHost_role());
		}
