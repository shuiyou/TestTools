...
import com.mgs.bean.WebRealNamePicAuthBean;
 ...
 */
@Controller
public class WebRealNamePicAuth extends HttpServlet {
    ...
    @RequestMapping(value = "WebRealNamePicAuth")
    public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
                       @ModelAttribute("qvBean") WebRealNamePicAuthBean qvBean,
