...
import com.pas.bean.QueryErpInfoBean;
...
@Controller
public class QueryErpInfo extends HttpServlet{

	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "QueryErpInfo")
	public void doPost(@ModelAttribute("pasBaseBean") PasBaseBean pasBaseBean,
					   @ModelAttribute("vbcBean") QueryErpInfoBean vbcBean,
