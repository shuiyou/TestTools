...
import com.mgs.bean.QueryIsSetBankPasswordBean;
 ...
 */
@Controller
public class QueryIsSetBankPassword extends HttpServlet {
	...
	@RequestMapping(value = "QueryIsSetBankPassword")
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("imbpBean") QueryIsSetBankPasswordBean imbpBean,
