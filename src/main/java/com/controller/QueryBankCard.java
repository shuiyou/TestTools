...
import com.mgs.bean.QueryBankCardBean;
 ...
 */
@Controller
public class QueryBankCard extends HttpServlet {
	...
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("qbcBean") QueryBankCardBean qbcBean,
		...
		if (!qbcBean.getIdentity_id().isEmpty()) {
			inputString.append(",identity_id=" + qbcBean.getIdentity_id());
		}
		if (!qbcBean.getIdentity_type().isEmpty()) {
			inputString.append(",identity_type=" + qbcBean.getIdentity_type());
		}
		if (!qbcBean.getCard_id().isEmpty()) {
			inputString.append(",card_id=" + qbcBean.getCard_id());
		}
		if (!qbcBean.getExtend_param().isEmpty()) {
			inputString.append(",extend_param=" + qbcBean.getExtend_param());
		}
		...
		qbcBean.setEncodeString(sortString);
		if (!mgsBaseBean.getNotify_url().isEmpty()) {
			qbcBean.setEncodeString(tool.removeFromString(
					qbcBean.getEncodeString(), "&", "&", "startswith",
					"notify_url")
					+ "&notify_url="
		...
		String requestString = qbcBean.getEncodeString() + "&sign="
