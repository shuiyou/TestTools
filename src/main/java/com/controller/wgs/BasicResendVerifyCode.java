...
import com.wgsBean.BasicResendVerifyCodeBean;
 ...
 */
@Controller
public class BasicResendVerifyCode extends HttpServlet
{
    /**
     *
     */
    ...
    @RequestMapping(value = "BasicResendVerifyCode")
    public void doPost(@ModelAttribute("wgsBaseBean") WgsAuthorizedBean wgsathorizedBean,
                       @ModelAttribute("lsvcBean") BasicResendVerifyCodeBean lsvcBean,
   ...
   //     StringBuilder biz_content = new StringBuilder("");
        ...
        hashMap.put( "verify_token",lsvcBean.getVerify_token() );
        hashMap.put( "scene",lsvcBean.getScene() );
//        hashMap.put( "salt_id",lsvcBean.getSalt_id() );
