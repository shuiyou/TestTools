...
import com.wgsBean.BasicGetSaltBean;
 ...
 */
@Controller
public class BasicGetSalt extends HttpServlet
{
	/**
	 *
	 */
			...
			throws IOException, ServletException
	{
		...
		hashMap.put( "scene",bgsBean.getScene() );
		String need = JSONObject.toJSONString( hashMap );
		if(!bgsBean.getScene().isEmpty()){
