...
import com.wgsBean.SavingPotDepositAndWithdrawDetailBean;
 ...
 */
@Controller
public class SavingPotDepositAndWithdrawDetail extends HttpServlet
{
	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "SavingPotDepositAndWithdrawDetail")
	public void doPost(@ModelAttribute("wgsathorizedBean") WgsAuthorizedBean wgsathorizedBean,
			@ModelAttribute("spdawdBean") SavingPotDepositAndWithdrawDetailBean spdawdBean,
			...
			throws IOException, ServletException
	{
		...
		hashMap.put( "out_trade_no",spdawdBean.getOut_trade_no() );
