...
import com.wgsBean.PersonalBankCardChangeMobileAdBean;
 ...
 */
@Controller
public class PersonalBankCardChangeMobileAd extends HttpServlet {
    /**
     *
     */
    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "PersonalBankCardChangeMobileAd")
    public void doPost(@ModelAttribute("wgsathorizedBean") WgsAuthorizedBean wgsathorizedBean,
                       @ModelAttribute("rgsBean") PersonalBankCardChangeMobileAdBean wgsBean,
            ...
            throws IOException, ServletException
    {
        ...
        hashMap.put( "verify_token",wgsBean.getVerify_token() );
        hashMap.put( "valid_code",wgsBean.getValid_code() );
