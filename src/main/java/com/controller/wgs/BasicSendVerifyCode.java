...
import com.wgsBean.BasicSendVerifyCodeBean;
 ...
 */
@Controller
public class BasicSendVerifyCode extends HttpServlet
{
	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "BasicSendVerifyCode")
	public void doPost(@ModelAttribute("wgsathorizedBean") WgsAuthorizedBean wgsathorizedBean,
			@ModelAttribute("bgvcBean")BasicSendVerifyCodeBean bgvcBean,
			...
			throws IOException, ServletException
	{
		...
		hashMap.put( "scene",bgvcBean.getScene() );
		hashMap.put( "send_type",bgvcBean.getSend_type() );
