...
import com.wgsBean.PersonalBankCardQueryCardBinBean;
 ...
 */
@Controller
public class PersonalBankCardQueryCardBin extends HttpServlet {
    /**
     *
     */
    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "PersonalBankCardQueryCardBin")
    public void doPost(@ModelAttribute("wgsathorizedBean") WgsAuthorizedBean wgsathorizedBean,
                       @ModelAttribute("rgsBean") PersonalBankCardQueryCardBinBean rgsBean,
            ...
            throws IOException, ServletException
    {
        ...
        String encryptCard_no = AesUtil.encrypt(rgsBean.getCard_no(),rgsBean.getSalt());
