...
import com.wgsBean.SavingPotEstimateYieldBean;
 ...
 */
@Controller
public class SavingPotEstimateYield extends HttpServlet
{
	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "SavingPotEstimateYield")
	public void doPost(@ModelAttribute("wgsathorizedBean") WgsAuthorizedBean wgsathorizedBean,
			@ModelAttribute("speyBean") SavingPotEstimateYieldBean speyBean,
			...
			throws IOException, ServletException
	{
		...
		hashMap.put( "amount",speyBean.getAmount() );
