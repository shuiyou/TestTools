...
import com.pas.bean.ValidateIdPhotoBean;


@Controller
public class ValidateIdPhoto extends HttpServlet{

    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "ValidateIdPhoto")
    public void doPost(@ModelAttribute("pasBaseBean") PasBaseBean pasBaseBean,
	    @ModelAttribute("vbcBean") ValidateIdPhotoBean vbcBean,
