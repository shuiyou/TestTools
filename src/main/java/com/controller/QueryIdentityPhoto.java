...
import com.mgs.bean.QueryIdentityPhotoBean;
 ...
 */
@Controller
public class QueryIdentityPhoto extends HttpServlet {
	...
	@RequestMapping(value = "QueryIdentityPhoto")
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("srnBean") QueryIdentityPhotoBean srnBean,
