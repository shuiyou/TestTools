...
@Controller
public class GoodsCanbuyGet extends HttpServlet {
	
	
	private static final long serialVersionUID = 1L;

	@RequestMapping(value = "GoodsCanbuyGet")
	public void doPost(@ModelAttribute("goodsInfoGet") GoodsInfoGetBean goodsInfoGet,
		...
		if(!goodsInfoGet.getMember_id().isEmpty())
		{
			inputmap.put("member_id", goodsInfoGet.getMember_id());
		}
