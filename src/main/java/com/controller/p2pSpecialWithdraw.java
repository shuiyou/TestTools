...
import com.mas.bean.P2PSpecialWithdrawBean;
 ...
 */
@Controller
public class p2pSpecialWithdraw extends HttpServlet {
	...
	@RequestMapping(value = "p2pSpecialWithdraw")
	public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
			@ModelAttribute("phtBean") P2PSpecialWithdrawBean phtBean,
