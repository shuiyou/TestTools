 ...
 */
@Controller
public class BindingBankCardAdvance extends HttpServlet {
	...
	@RequestMapping(value = "BindingBankCardAdvance")
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("bbcaBean") BindingBankCardAdvanceBean bbcaBean,
