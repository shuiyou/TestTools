...
import com.mgs.bean.SetMemberHostRoleBean;
 ...
 */
@Controller
public class SetMemberHostRole extends HttpServlet {
    ...
    @RequestMapping(value = "SetMemberHostRole")
    public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
                       @ModelAttribute("SetMemberHostRole") SetMemberHostRoleBean camBean,
        ...
        if (!camBean.getClient_ip().isEmpty()) {
