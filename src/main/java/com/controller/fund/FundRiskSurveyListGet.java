...
import com.fund.bean.FundRiskSurveyListGetBean;
 ...
 */
@Controller
public class FundRiskSurveyListGet extends HttpServlet{
    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "FundRiskSurveyListGet")
    public void doPost(@ModelAttribute("FundBaseBean") FundBaseBean fundBaseBean,
                       @ModelAttribute("frslgBean") FundRiskSurveyListGetBean frslgBean,
        ...
        if (!frslgBean.getMember_id().isEmpty()) {
            inputString.append(",member_id=" + frslgBean.getMember_id());
        }
        ...
        frslgBean.setEncodeString(sortString);
        String requestString = frslgBean.getEncodeString() + "&sign="
