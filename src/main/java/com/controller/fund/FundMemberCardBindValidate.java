 ...
 */
@Controller
public class FundMemberCardBindValidate extends HttpServlet {
    ...
    @RequestMapping(value = "FundMemberCardBindValidate")
    public void doPost(@ModelAttribute("FundBaseBean") FundBaseBean fundBaseBean, @ModelAttribute("fmcbvBean") FundMemberCardBindValidateBean fmcbvBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (!fmcbvBean.getMember_id().isEmpty()) {
            inputString.append(",member_id=" + fmcbvBean.getMember_id());
        }
        if (!fmcbvBean.getPayment_id().isEmpty()) {
            inputString.append(",payment_id=" + fmcbvBean.getPayment_id());
        }
        ...
        fmcbvBean.setEncodeString(sortString);
        String requestString = fmcbvBean.getEncodeString() + "&sign=" + tool.textEncode(sign, "UTF-8");
