...
import com.fund.bean.SavingpotFundProfitListBean;
 ...
 */
@Controller
public class SavingpotFundProfitList extends HttpServlet {
    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "SavingpotFundProfitList")
    public void doPost(@ModelAttribute("FundBaseBean") FundBaseBean fundBaseBean, @ModelAttribute("sfplBean") SavingpotFundProfitListBean sfplBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (!sfplBean.getFund_code().isEmpty()) {
            inputString.append(",fund_code=" + sfplBean.getFund_code());
        }
        ...
        sfplBean.setEncodeString(sortString);

        String requestString = sfplBean.getEncodeString() + "&sign=" + tool.textEncode(sign, "UTF-8");
