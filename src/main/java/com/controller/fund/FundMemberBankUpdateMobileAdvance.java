...
import com.fund.bean.FundMemberBankUpdateMobileAdvanceBean;
 ...
 */
@Controller
public class FundMemberBankUpdateMobileAdvance extends HttpServlet {
    ...
    @RequestMapping(value = "FundMemberBankUpdateMobileAdvance")
    public void doPost(@ModelAttribute("FundBaseBean") FundBaseBean fundBaseBean,
                       @ModelAttribute("fmbumBean") FundMemberBankUpdateMobileAdvanceBean fmbumaBean,
        ...
        if (!fmbumaBean.getMember_id().isEmpty()) {
            inputString.append(",member_id=" + fmbumaBean.getMember_id());
        }
        if (!fmbumaBean.getPayment_method_id().isEmpty()) {
            inputString.append(",payment_method_id=" + fmbumaBean.getPayment_method_id());
        }
        if (!fmbumaBean.getValid_code().isEmpty()) {
            inputString.append(",valid_code=" + fmbumaBean.getValid_code());
        }
        ...
        fmbumaBean.setEncodeString(sortString);


        String requestString = fmbumaBean.getEncodeString() + "&sign="
