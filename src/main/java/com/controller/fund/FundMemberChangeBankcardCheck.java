...
import com.fund.bean.FundInvestPlanListGetBean;
import com.fund.bean.FundMemberChangeBankcardCheckBean;
 ...
 */
@Controller
public class FundMemberChangeBankcardCheck extends HttpServlet {
    ...
    @RequestMapping(value = "FundMemberChangeBankcardCheck")
    public void doPost(@ModelAttribute("FundBaseBean") FundBaseBean fundBaseBean, @ModelAttribute("fmcbcBean") FundMemberChangeBankcardCheckBean fmcbcBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (!fmcbcBean.getMember_id().isEmpty()) {
            inputString.append(",member_id=" + fmcbcBean.getMember_id());
        }
        if (!fmcbcBean.getOld_payment_method_id().isEmpty()) {
            inputString.append(",old_payment_method_id=" + fmcbcBean.getOld_payment_method_id());
        }
        ...
        fmcbcBean.setEncodeString(sortString);
        String requestString = fmcbcBean.getEncodeString() + "&sign=" + tool.textEncode(sign, "UTF-8");
