...
import com.sh_bank.bean.OpenAccount_shBean;
 ...
 */
@Controller
public class OpenAccount_sh extends HttpServlet {
    ...
    @RequestMapping(value = "OpenAccount_sh")
    public void doPost(@ModelAttribute("masBaseBean") ShMgsBaseBean masBaseBean,
            @ModelAttribute("chrBean") OpenAccount_shBean chrBean, HttpServletRequest request,
        ...
        if (!chrBean.getRequest_no().isEmpty()) {
            inputString.append(",request_no=" + chrBean.getRequest_no());
        }
