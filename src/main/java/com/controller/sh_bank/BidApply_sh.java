...
import com.sh_bank.bean.BidApply_shBean;
 ...
 */
@Controller
public class BidApply_sh extends HttpServlet {
    ...
    @RequestMapping(value = "BidApply_sh")
    public void doPost(@ModelAttribute("masBaseBean") ShMasBaseBean masBaseBean,
                       @ModelAttribute("cbiBean") BidApply_shBean cbiBean,
