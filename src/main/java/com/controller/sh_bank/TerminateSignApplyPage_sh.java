...
import com.sh_bank.bean.SignAutoApply_shBean;
import com.sh_bank.bean.TerminateSignApplyPage_shBean;
 ...
 */
@Controller
public class TerminateSignApplyPage_sh extends HttpServlet {
    ...
    @RequestMapping(value = "TerminateSignApplyPage_sh")
    public void doPost(@ModelAttribute("masBaseBean") ShMasBaseBean masBaseBean,
                       @ModelAttribute("cbiBean") TerminateSignApplyPage_shBean cbiBean,
        ...
        if (!cbiBean.getIdentity_id().isEmpty()) {
            inputString.append(",identity_id=" + cbiBean.getIdentity_id());
        }
        if (!cbiBean.getIdentity_type().isEmpty()) {
            inputString.append(",identity_type=" + cbiBean.getIdentity_type());
        }
