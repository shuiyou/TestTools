...
import com.sh_bank.bean.ModifyVerifyMobilePage_shBean;
 ...
 */
public class ModifyVerifyMobilePage_sh extends HttpServlet {
    private static final long serialVersionUID = 1L;

    @RequestMapping(value = "ModifyVerifyMobilePage_sh")
    public void doPost(@ModelAttribute("masBaseBean") MasBaseBean masBaseBean,
                       @ModelAttribute("chrBean") ModifyVerifyMobilePage_shBean chrBean, HttpServletRequest request,
