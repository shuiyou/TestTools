...
import com.sh_bank.bean.QueryBidInfo_shBean;
...
import com.mas.bean.QueryBidBean;
 ...
 */
@Controller
public class QueryBidInfo_sh extends HttpServlet {
    ...
    @RequestMapping(value = "QueryBidInfo_sh")
    public void doPost(@ModelAttribute("masBaseBean") ShMasBaseBean masBaseBean,
                       @ModelAttribute("chwBean") QueryBidInfo_shBean chwBean,
        ...
        if (!chwBean.getOut_bid_no().isEmpty()) {
            inputString.append(",out_bid_no=" + chwBean.getOut_bid_no());
        }
