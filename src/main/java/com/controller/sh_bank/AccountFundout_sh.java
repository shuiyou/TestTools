...
import com.sh_bank.bean.AccountFundout_shBean;
 ...
 */
@Controller
public class AccountFundout_sh extends HttpServlet {
	...
	@RequestMapping(value = "AccountFundout_sh")
	public void doPost(@ModelAttribute("masBaseBean") ShMasBaseBean masBaseBean,
			@ModelAttribute("chwBean") AccountFundout_shBean chwBean, HttpServletRequest request,
