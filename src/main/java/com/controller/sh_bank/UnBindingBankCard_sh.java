...
import com.sh_bank.bean.UnBindingBankCard_shBean;
 ...
 */
@Controller
public class UnBindingBankCard_sh extends HttpServlet {
    ...
    @RequestMapping(value = "UnBindingBankCard_sh")
    public void doPost(@ModelAttribute("mgsBaseBean") ShMgsBaseBean mgsBaseBean,
                       @ModelAttribute("ubbcBean") UnBindingBankCard_shBean ubbcBean,
