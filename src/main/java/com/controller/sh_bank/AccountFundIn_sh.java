 ...
 */
@Controller
public class AccountFundIn_sh extends HttpServlet {
    ...
    @RequestMapping(value = "AccountFundIn_sh")
    public void doPost(@ModelAttribute("masBaseBean") ShMasBaseBean masBaseBean,
            @ModelAttribute("chrBean") AccountFundIn_shBean chrBean, HttpServletRequest request,
