...
import com.sh_bank.bean.CreateDebtMigration_shBean;
 ...
 */
@Controller
public class CreateDebtMigration_sh extends HttpServlet {
    ...
    @RequestMapping(value = "CreateDebtMigration_sh")
    public void doPost(@ModelAttribute("masBaseBean") ShMasBaseBean masBaseBean,
                       @ModelAttribute("cbiBean") CreateDebtMigration_shBean cbiBean,
        ...
        if (!cbiBean.getGoods_id().isEmpty()) {
            inputString.append(",goods_id=" + cbiBean.getGoods_id());
        }
