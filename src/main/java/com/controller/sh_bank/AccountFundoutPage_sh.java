...
import com.sh_bank.bean.AccountFundoutPage_shBean;
 ...
 */
@Controller
public class AccountFundoutPage_sh extends HttpServlet {
    ...
    @RequestMapping(value = "AccountFundoutPage_sh")
    public void doPost(@ModelAttribute("masBaseBean") ShMasBaseBean masBaseBean,
                       @ModelAttribute("chwBean") AccountFundoutPage_shBean chwBean, HttpServletRequest request,
        ...
        if (!chwBean.getOut_trade_code().isEmpty()) {
            inputString.append(",out_trade_code=" + chwBean.getOut_trade_code());
        }
