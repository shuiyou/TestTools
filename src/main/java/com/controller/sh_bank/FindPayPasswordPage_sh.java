...
import com.sh_bank.bean.FindPayPasswordPage_shBean;
 ...
 */
@Controller
public class FindPayPasswordPage_sh extends HttpServlet {
    ...
    @RequestMapping(value = "FindPayPasswordPage_sh")
    public void doPost(@ModelAttribute("mgsBaseBean") ShMgsBaseBean mgsBaseBean,
                       @ModelAttribute("ubbcBean") FindPayPasswordPage_shBean ubbcBean,
