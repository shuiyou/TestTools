...
import com.sh_bank.bean.ModifyPayPasswordPage_shBean;
 ...
 */
@Controller
public class ModifyPayPasswordPage_sh extends HttpServlet {
    ...
    @RequestMapping(value = "ModifyPayPasswordPage_sh")
    public void doPost(@ModelAttribute("mgsBaseBean") ShMgsBaseBean mgsBaseBean,
                       @ModelAttribute("ubbcBean") ModifyPayPasswordPage_shBean ubbcBean,
        ...
        if (!mgsBaseBean.getCashdesk_addr_category().isEmpty()) {
            inputString
                    .append(",cashdesk_addr_category=" + mgsBaseBean.getCashdesk_addr_category());
        }
