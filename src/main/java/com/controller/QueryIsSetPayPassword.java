...
import com.mgs.bean.QueryIsSetPayPasswordBean;
 ...
 */
@Controller
public class QueryIsSetPayPassword extends HttpServlet {
	...
	@RequestMapping(value = "QueryIsSetPayPassword")
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("camBean") QueryIsSetPayPasswordBean sppBean,
