...
import com.mgs.bean.OpenAccountBean;
...
public class OpenAccount extends HttpServlet {
	...
	public void doPost(@ModelAttribute("mgsBaseBean") MgsBaseBean mgsBaseBean,
			@ModelAttribute("camBean") OpenAccountBean camBean,
		...
		if (!camBean.getAccount_type().isEmpty()) {
			inputString.append(",account_type=" + camBean.getAccount_type());
		}
