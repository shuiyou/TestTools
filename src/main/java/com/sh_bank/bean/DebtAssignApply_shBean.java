 ...
 */
public class DebtAssignApply_shBean {
    ...
    public String getTr_share() {
        return tr_share;
    }

    public void setTr_share(String tr_share) {
        this.tr_share = tr_share;
    }

    public String getTr_yield() {
        return tr_yield;
    }

    public void setTr_yield(String tr_yield) {
        this.tr_yield = tr_yield;
    }

    public String getTr_int_date() {
        return tr_int_date;
    }

    public void setTr_int_date(String tr_int_date) {
        this.tr_int_date = tr_int_date;
    }
    ...
    private String tr_share;
    private String tr_yield;
    private String tr_int_date;
